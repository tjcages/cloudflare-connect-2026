/** @deprecated Import from `./playgroundTextures` instead. */
export {
  DEFAULT_PLAYGROUND_TEXTURE_ID as DEFAULT_PLAYGROUND_VIDEO_ID,
  getPlaygroundTextureOption as getPlaygroundVideoOption,
