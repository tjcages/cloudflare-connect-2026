...
export function Hero() {
  ...
  return [
    ...
    "",
    "Run the target project's lint and typecheck (e.g. `npm run lint`, `npm run typecheck`, or `tsc --noEmit`). Fix every ESLint/Prettier/Biome issue and TypeScript error. Re-run until clean. Follow existing import rules, React hooks rules, and client-component boundaries.",
    "",
