...
- Prefer Workers preview versions / dashboard for `connect-shader`, not ad-hoc tunnels, for anything shared with the team or clients.
- Session tunnels are OK for agent smoke checks only.
