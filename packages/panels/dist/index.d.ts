 ...
 * look never forks.
 */
declare function PanelCloseButton({ onClick, ariaLabel, size, disabled, className, title, }: PanelCloseButtonProps): react.JSX.Element;
declare function PanelCloseIcon(): react.JSX.Element;
...
interface PanelHeaderSelectOption {
    value: string;
    label: string;
}
interface PanelHeaderSelectProps {
    value: string;
 ...
 */
declare function PanelHeaderSelect({ value, options, onChange, ariaLabel, }: PanelHeaderSelectProps): react.JSX.Element;
