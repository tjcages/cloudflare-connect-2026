/**
 * Capture CF-16 Z-scattered amplitude heat refinement candidates.
 *
 * Usage:
 *   pir exec node scripts/capture-twizzler-z-heat-pass2.mjs
 */
...
const variants = [
  {
    id: "A2",
    label: "sparse broad hot sheets · asymmetric depth weighting",
    heatVariant: 3,
    structure: "3 authored sheets",
  },
  {
    id: "B2",
    label: "medium clustered Z islands · uneven spacing and width",
    heatVariant: 4,
    structure: "6 irregular islands",
  },
  {
    id: "C2",
    label: "dense spots · alternating hot/cool depth groups",
    heatVariant: 5,
    structure: "11 grouped spots",
  },
];

const bundlePath = "/tmp/twizzler-z-heat-pass2-bundle.js";
...
for (const variant of variants) {
  ...
  const outPath = resolve(outDir, `twizzler-z-heat-pass2-${variant.id}.png`);
...
const stackPath = resolve(outDir, "twizzler-z-heat-pass2-STACK.png");
...
writeFileSync(resolve(outDir, "twizzler-z-heat-pass2-manifest.json"), JSON.stringify(manifest, null, 2));
