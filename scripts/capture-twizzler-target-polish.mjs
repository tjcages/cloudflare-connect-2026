...
const variants = [
  {
    id: "A",
    label: "hot-lobe contour · E2 energy + P3 spread + gentle S1 bends",
    settings: {
      ...lockB,
      targetPolish: 1,
      centerY: 0.52,
  ...
  {
    id: "B",
    label: "hairline fan · D2 strokes + stronger S2 bends + S3 lift",
    settings: {
      ...lockB,
      targetPolish: 2,
      centerY: 0.53,
  ...
  {
    id: "C",
    label: "dense depth field · D3 signal at 264 + hairlines + P3/S3",
    settings: {
      ...lockB,
      targetPolish: 3,
      centerY: 0.52,
...
const manifest = {
  ...
  preferenceSignals: {
    E2: "hotter amplitude",
    D2: "hairline strokes",
    D3: "denser field, capped at 264 to preserve the approximately-240 lock",
    P3: "more depth spread",
    S1: "gentler bends",
    S2: "stronger bends",
    S3: "maximum supported depth lift",
  },
