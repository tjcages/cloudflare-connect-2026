...
export function useEngineControls(
  ...
  useEffect(() => {
    ...
    shaderControlSetterRef.current?.({
      ...
      twizzlerRotateX: tweaks.rotateXDeg,
      twizzlerRotateY: tweaks.rotateYDeg,
      twizzlerRotateZ: tweaks.rotateZDeg,
  ...
  return {
    ...
    twizzler: {
      ...
      ...normalizeTwizzlerSettings({
        ...
        rotateXDeg: shaderValueRecord.twizzlerRotateX,
        rotateYDeg: shaderValueRecord.twizzlerRotateY,
        rotateZDeg: shaderValueRecord.twizzlerRotateZ,
