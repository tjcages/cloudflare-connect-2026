...
export function useEngineControls(
    ...
    () =>
      orderShaderPanel({
        ...
        Reveal: drawerFolder("Reveal", {
          ...
          revealWarpTunnelSpeedMinMs: {
            value: d.reveal.warptunnel.speedMinMs,
            min: 50,
            max: 30000,
            step: 10,
            label: "Speed min (ms)",
            render: (get) => get("Reveal.revealType") === "warptunnel",
          },
          revealWarpTunnelSpeedMaxMs: {
            value: d.reveal.warptunnel.speedMaxMs,
            min: 50,
            max: 30000,
            step: 10,
            label: "Speed max (ms)",
          ...
          revealWarpTunnelStaggerMs: {
            value: d.reveal.warptunnel.staggerMs,
            min: 0,
            max: 30000,
            step: 10,
            label: "Stagger (ms)",
          ...
          revealWarpTunnelIntensity: {
            value: d.reveal.warptunnel.intensity,
            min: 0,
            max: 2,
            step: 0.05,
            label: "Intensity",
          ...
          revealWarpTunnelDetail: {
            value: d.reveal.warptunnel.detail,
            min: 0,
            max: 1,
            step: 0.05,
            label: "Detail",
          ...
          revealWarpTunnelGlow: {
            value: d.reveal.warptunnel.glow,
            min: 0,
            max: 1,
            step: 0.05,
            label: "Glow",
          ...
          revealMeteorSpeedMinMs: {
            value: d.reveal.meteor.speedMinMs,
            min: 50,
            max: 30000,
            step: 10,
            label: "Speed min (ms)",
            render: (get) => get("Reveal.revealType") === "meteor",
          },
          revealMeteorSpeedMaxMs: {
            value: d.reveal.meteor.speedMaxMs,
            min: 50,
            max: 30000,
            step: 10,
            label: "Speed max (ms)",
          ...
          revealMeteorStaggerMs: {
            value: d.reveal.meteor.staggerMs,
            min: 0,
            max: 30000,
            step: 10,
            label: "Stagger (ms)",
          ...
          revealMeteorIntensity: {
            value: d.reveal.meteor.intensity,
            min: 0,
            max: 2,
            step: 0.05,
            label: "Intensity",
          ...
          revealBeamSpeedMinMs: {
            value: d.reveal.beam.speedMinMs,
            min: 50,
            max: 30000,
            step: 10,
            label: "Speed min (ms)",
            render: (get) => get("Reveal.revealType") === "beam",
          },
          revealBeamSpeedMaxMs: {
            value: d.reveal.beam.speedMaxMs,
            min: 50,
            max: 30000,
            step: 10,
            label: "Speed max (ms)",
          ...
          revealPlasmaSpeedMinMs: {
            value: d.reveal.plasma.speedMinMs,
            min: 50,
            max: 30000,
            step: 10,
            label: "Speed min (ms)",
            render: (get) => get("Reveal.revealType") === "plasma",
          },
          revealPlasmaSpeedMaxMs: {
            value: d.reveal.plasma.speedMaxMs,
            min: 50,
            max: 30000,
            step: 10,
            label: "Speed max (ms)",
          ...
          revealPlasmaStaggerMs: {
            value: d.reveal.plasma.staggerMs,
            min: 0,
            max: 30000,
            step: 10,
            label: "Stagger (ms)",
          ...
          revealPlasmaIntensity: {
            value: d.reveal.plasma.intensity,
            min: 0,
            max: 2,
            step: 0.05,
            label: "Intensity",
  ...
  const config = normalizeEngineConfig({
    ...
    reveal: {
      ...
      warptunnel: {
        speedMinMs: values.revealWarpTunnelSpeedMinMs,
        speedMaxMs: values.revealWarpTunnelSpeedMaxMs,
        staggerMs: values.revealWarpTunnelStaggerMs,
        intensity: values.revealWarpTunnelIntensity,
        detail: values.revealWarpTunnelDetail,
        glow: values.revealWarpTunnelGlow,
      },
      meteor: {
        speedMinMs: values.revealMeteorSpeedMinMs,
        speedMaxMs: values.revealMeteorSpeedMaxMs,
        staggerMs: values.revealMeteorStaggerMs,
        intensity: values.revealMeteorIntensity,
        detail: values.revealMeteorDetail,
        glow: values.revealMeteorGlow,
      },
      beam: {
        speedMinMs: values.revealBeamSpeedMinMs,
        speedMaxMs: values.revealBeamSpeedMaxMs,
        staggerMs: values.revealBeamStaggerMs,
        intensity: values.revealBeamIntensity,
        detail: values.revealBeamDetail,
        glow: values.revealBeamGlow,
      },
      plasma: {
        speedMinMs: values.revealPlasmaSpeedMinMs,
        speedMaxMs: values.revealPlasmaSpeedMaxMs,
        staggerMs: values.revealPlasmaStaggerMs,
        intensity: values.revealPlasmaIntensity,
        detail: values.revealPlasmaDetail,
        glow: values.revealPlasmaGlow,
      },
    },
    sparkle: {
      gaps: {
