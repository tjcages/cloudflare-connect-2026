        ...
        Reveal: drawerFolder("Reveal", {
          ...
          Reset: button(() => {
            shaderControlSetterRef.current?.({
              revealType: d.reveal.type,
              revealPosition: d.reveal.wave.position,
              revealDurationMs: d.reveal.wave.durationMs,
              revealSoftness: d.reveal.wave.softness,
              revealWaviness: d.reveal.wave.waviness,
              revealSliceSizePx: d.reveal.assembly.sliceSizePx,
              revealSpeedMinMs: d.reveal.assembly.speedMinMs,
              revealSpeedMaxMs: d.reveal.assembly.speedMaxMs,
              revealStaggerMs: d.reveal.assembly.staggerMs,
              revealScatterPx: d.reveal.assembly.scatterPx,
              revealAngleJitterDeg: d.reveal.assembly.angleJitterDeg,
              revealTurbSpeedMinMs: d.reveal.turbulence.speedMinMs,
              revealTurbSpeedMaxMs: d.reveal.turbulence.speedMaxMs,
              revealTurbStaggerMs: d.reveal.turbulence.staggerMs,
              revealTurbIntensity: d.reveal.turbulence.intensity,
              revealTurbDetail: d.reveal.turbulence.detail,
              revealTurbGlow: d.reveal.turbulence.glow,
              revealGlitchSpeedMinMs: d.reveal.glitch.speedMinMs,
              revealGlitchSpeedMaxMs: d.reveal.glitch.speedMaxMs,
              revealGlitchStaggerMs: d.reveal.glitch.staggerMs,
              revealGlitchIntensity: d.reveal.glitch.intensity,
              revealGlitchDetail: d.reveal.glitch.detail,
              revealGlitchGlow: d.reveal.glitch.glow,
              revealVorSpeedMinMs: d.reveal.vortex.speedMinMs,
              revealVorSpeedMaxMs: d.reveal.vortex.speedMaxMs,
              revealVorStaggerMs: d.reveal.vortex.staggerMs,
              revealVorIntensity: d.reveal.vortex.intensity,
              revealVorDetail: d.reveal.vortex.detail,
              revealVorSwirl: d.reveal.vortex.swirl,
              revealVorGlow: d.reveal.vortex.glow,
              revealWaterDurationMs: d.reveal.water.durationMs,
              revealWaterSettleMs: d.reveal.water.settleMs,
              revealWaterRows: d.reveal.water.rows,
              revealWaterIntensity: d.reveal.water.intensity,
              revealWaterWobble: d.reveal.water.wobble,
              revealWaterRefraction: d.reveal.water.refraction,
              revealWaterSoftness: d.reveal.water.softness,
            });
          }),
        }),
