...
export function useEngineControls(
    ...
    () =>
      orderShaderPanel({
        ...
        Reveal: drawerFolder("Reveal", {
          ...
          revealBurnSpeedMinMs: {
            value: d.reveal.burn.speedMinMs,
            min: 50,
            max: 30000,
            step: 10,
            label: "Speed min (ms)",
            render: (get) => get("Reveal.revealType") === "burn",
          },
          revealBurnSpeedMaxMs: {
            value: d.reveal.burn.speedMaxMs,
            min: 50,
            max: 30000,
            step: 10,
            label: "Speed max (ms)",
          ...
          revealPortalSpeedMinMs: {
            value: d.reveal.portal.speedMinMs,
            min: 50,
            max: 30000,
            step: 10,
            label: "Speed min (ms)",
            render: (get) => get("Reveal.revealType") === "portal",
          },
          revealPortalSpeedMaxMs: {
            value: d.reveal.portal.speedMaxMs,
            min: 50,
            max: 30000,
            step: 10,
            label: "Speed max (ms)",
          ...
          revealPortalStaggerMs: {
            value: d.reveal.portal.staggerMs,
            min: 0,
            max: 30000,
            step: 10,
            label: "Stagger (ms)",
          ...
          revealPortalIntensity: {
            value: d.reveal.portal.intensity,
            min: 0,
            max: 2,
            step: 0.05,
            label: "Intensity",
          ...
          revealLightningSpeedMinMs: {
            value: d.reveal.lightning.speedMinMs,
            min: 50,
            max: 30000,
            step: 10,
            label: "Speed min (ms)",
            render: (get) => get("Reveal.revealType") === "lightning",
          },
          revealLightningSpeedMaxMs: {
            value: d.reveal.lightning.speedMaxMs,
            min: 50,
            max: 30000,
            step: 10,
            label: "Speed max (ms)",
          ...
          revealLightningStaggerMs: {
            value: d.reveal.lightning.staggerMs,
            min: 0,
            max: 30000,
            step: 10,
            label: "Stagger (ms)",
          ...
          revealLightningIntensity: {
            value: d.reveal.lightning.intensity,
            min: 0,
            max: 2,
            step: 0.05,
            label: "Intensity",
          ...
          revealLightningDetail: {
            value: d.reveal.lightning.detail,
            min: 0,
            max: 1,
            step: 0.05,
            label: "Detail",
  ...
  const config = normalizeEngineConfig({
    ...
    reveal: {
      ...
      burn: {
        speedMinMs: values.revealBurnSpeedMinMs,
        speedMaxMs: values.revealBurnSpeedMaxMs,
        staggerMs: values.revealBurnStaggerMs,
        intensity: values.revealBurnIntensity,
        detail: values.revealBurnDetail,
        glow: values.revealBurnGlow,
      },
      portal: {
        speedMinMs: values.revealPortalSpeedMinMs,
        speedMaxMs: values.revealPortalSpeedMaxMs,
        staggerMs: values.revealPortalStaggerMs,
        intensity: values.revealPortalIntensity,
        detail: values.revealPortalDetail,
        glow: values.revealPortalGlow,
      },
      lightning: {
        speedMinMs: values.revealLightningSpeedMinMs,
        speedMaxMs: values.revealLightningSpeedMaxMs,
        staggerMs: values.revealLightningStaggerMs,
        intensity: values.revealLightningIntensity,
        detail: values.revealLightningDetail,
        glow: values.revealLightningGlow,
      },
    },
    sparkle: {
      gaps: {
