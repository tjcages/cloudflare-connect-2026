    ...
    () =>
      orderShaderPanel({
        ...
        Reveal: drawerFolder("Reveal", {
          ...
          revealSliceSizePx: {
            value: d.reveal.assembly.scatter.sliceSizePx,
            min: 8,
            max: 200,
            step: 1,
            label: "Slice size (px)",
          ...
          revealSpeedMinMs: {
            value: d.reveal.assembly.scatter.speedMinMs,
            min: 100,
            max: 30000,
            step: 50,
            label: "Speed min (ms)",
          ...
          revealSpeedMaxMs: {
            value: d.reveal.assembly.scatter.speedMaxMs,
            min: 100,
            max: 30000,
            step: 50,
            label: "Speed max (ms)",
          ...
          revealStaggerMs: {
            value: d.reveal.assembly.scatter.staggerMs,
            min: 0,
            max: 30000,
            step: 50,
            label: "Stagger (ms)",
          ...
          revealScatterPx: {
            value: d.reveal.assembly.scatter.scatterPx,
            min: 0,
            max: 300,
            step: 1,
            label: "Scatter (px)",
          ...
          revealAngleJitterDeg: {
            value: d.reveal.assembly.scatter.angleJitterDeg,
            min: 0,
            max: 90,
            step: 1,
            label: "Angle jitter (°)",
          ...
          revealTurbSpeedMinMs: {
            value: d.reveal.assembly.turbulence.speedMinMs,
            min: 50,
            max: 30000,
            step: 10,
            label: "Speed min (ms)",
            render: (get) =>
              get("Reveal.revealType") === "assembly" && get("Reveal.revealAssemblyStyle") === "turbulence",
          },
          revealTurbSpeedMaxMs: {
            value: d.reveal.assembly.turbulence.speedMaxMs,
            min: 50,
            max: 30000,
            step: 10,
            label: "Speed max (ms)",
          ...
          revealTurbStaggerMs: {
            value: d.reveal.assembly.turbulence.staggerMs,
            min: 0,
            max: 30000,
            step: 10,
            label: "Stagger (ms)",
          ...
          revealTurbIntensity: {
            value: d.reveal.assembly.turbulence.intensity,
            min: 0,
            max: 2,
            step: 0.05,
            label: "Intensity",
          ...
          revealTurbDetail: {
            value: d.reveal.assembly.turbulence.detail,
            min: 0,
            max: 1,
            step: 0.05,
            label: "Detail",
          ...
          revealTurbGlow: {
            value: d.reveal.assembly.turbulence.glow,
            min: 0,
            max: 1,
            step: 0.05,
            label: "Glow",
          ...
          revealGlitchSpeedMinMs: {
            value: d.reveal.assembly.glitch.speedMinMs,
            min: 50,
            max: 30000,
            step: 10,
            label: "Speed min (ms)",
            render: (get) => get("Reveal.revealType") === "assembly" && get("Reveal.revealAssemblyStyle") === "glitch",
          },
          revealGlitchSpeedMaxMs: {
            value: d.reveal.assembly.glitch.speedMaxMs,
            min: 50,
            max: 30000,
            step: 10,
            label: "Speed max (ms)",
          ...
          revealGlitchStaggerMs: {
            value: d.reveal.assembly.glitch.staggerMs,
            min: 0,
            max: 30000,
            step: 10,
            label: "Stagger (ms)",
          ...
          revealGlitchIntensity: {
            value: d.reveal.assembly.glitch.intensity,
            min: 0,
            max: 2,
            step: 0.05,
            label: "Intensity",
          ...
          revealGlitchDetail: {
            value: d.reveal.assembly.glitch.detail,
            min: 0,
            max: 1,
            step: 0.05,
            label: "Detail",
          ...
          revealGlitchGlow: {
            value: d.reveal.assembly.glitch.glow,
            min: 0,
            max: 1,
            step: 0.05,
            label: "Glow",
          ...
          revealHadSpeedMinMs: {
            value: d.reveal.assembly.hadouken.speedMinMs,
            min: 50,
            max: 30000,
            step: 10,
            label: "Speed min (ms)",
          ...
          revealHadSpeedMaxMs: {
            value: d.reveal.assembly.hadouken.speedMaxMs,
            min: 50,
            max: 30000,
            step: 10,
            label: "Speed max (ms)",
          ...
          revealHadStaggerMs: {
            value: d.reveal.assembly.hadouken.staggerMs,
            min: 0,
            max: 30000,
            step: 10,
            label: "Stagger (ms)",
          ...
          revealHadIntensity: {
            value: d.reveal.assembly.hadouken.intensity,
            min: 0,
            max: 2,
            step: 0.05,
            label: "Intensity",
          ...
          revealHadDetail: {
            value: d.reveal.assembly.hadouken.detail,
            min: 0,
            max: 1,
            step: 0.05,
            label: "Detail",
          ...
          revealHadGlow: {
            value: d.reveal.assembly.hadouken.glow,
            min: 0,
            max: 1,
            step: 0.05,
            label: "Glow",
          ...
          revealHadParticleCount: {
            value: d.reveal.assembly.hadouken.particleCount,
            min: 500,
            max: 20000,
            step: 100,
