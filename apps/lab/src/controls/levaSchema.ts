      ...
      orderShaderPanel({
        ...
        "Background Flames": drawerFolder("Background Flames", {
          ...
          flamesSwirlRate: {
            ...
            step: 0.05,
            label: "Swirl",
            render: (get) => flamesEnabledAnd(get, (dir) => dir === "vortex"),
          },
          flamesMinWidthPct: {
          ...
          flamesBitsScaleMinPct: {
            value: d.flames.bits.scaleMin * 100,
            min: 0.5,
            max: 50,
            step: 0.1,
            label: "Scale min %",
          ...
          flamesBitsScaleMaxPct: {
            value: d.flames.bits.scaleMax * 100,
            min: 0.5,
            max: 50,
            step: 0.1,
            label: "Scale max %",
          ...
          flamesBitsIntervalMinMs: {
            value: d.flames.bits.intervalMinMs,
            min: 10,
            max: 5000,
            step: 10,
            label: "Interval min (ms)",
          ...
          flamesBitsIntervalMaxMs: {
            value: d.flames.bits.intervalMaxMs,
            min: 10,
            max: 5000,
            step: 10,
            label: "Interval max (ms)",
          ...
          flamesBitsMaxInstances: {
            value: d.flames.bits.maxInstances,
            min: 1,
            max: 120,
            step: 1,
            label: "Max snakes",
  ...
  const config = normalizeEngineConfig({
    ...
    flames: {
      ...
      bits: {
        ...
        tailMax: values.flamesBitsTailMax,
        scaleMin: values.flamesBitsScaleMinPct / 100,
        scaleMax: values.flamesBitsScaleMaxPct / 100,
        thickness: values.flamesBitsThickness,
        speedMin: values.flamesBitsSpeedMin,
        speedMax: values.flamesBitsSpeedMax,
        intervalMinMs: values.flamesBitsIntervalMinMs,
        intervalMaxMs: values.flamesBitsIntervalMaxMs,
