...
export function useEngineControls(
    ...
    () =>
      orderShaderPanel({
        ...
        Reveal: drawerFolder("Reveal", {
          ...
          revealFluidSpeedMinMs: {
            value: d.reveal.fluid.speedMinMs,
            min: 50,
            max: 30000,
            step: 10,
            label: "Speed min (ms)",
            render: (get) => get("Reveal.revealType") === "fluid",
          },
          revealFluidSpeedMaxMs: {
            value: d.reveal.fluid.speedMaxMs,
            min: 50,
            max: 30000,
            step: 10,
            label: "Speed max (ms)",
          ...
          revealFluidStaggerMs: {
            value: d.reveal.fluid.staggerMs,
            min: 0,
            max: 30000,
            step: 10,
            label: "Stagger (ms)",
          ...
          revealFluidIntensity: {
            value: d.reveal.fluid.intensity,
            min: 0,
            max: 2,
            step: 0.05,
            label: "Intensity",
          ...
          revealStormSpeedMinMs: {
            ...
            step: 10,
            label: "Speed min (ms)",
            render: (get) => get("Reveal.revealType") === "storm",
          },
          revealStormSpeedMaxMs: {
            value: d.reveal.storm.speedMaxMs,
            min: 50,
            max: 30000,
            step: 10,
            label: "Speed max (ms)",
          ...
          revealStormStaggerMs: {
            value: d.reveal.storm.staggerMs,
            min: 0,
            max: 30000,
            step: 10,
            label: "Stagger (ms)",
          ...
          revealStormIntensity: {
            value: d.reveal.storm.intensity,
            min: 0,
            max: 2,
            step: 0.05,
            label: "Intensity",
          ...
          revealDetonationSpeedMinMs: {
            value: d.reveal.detonation.speedMinMs,
            min: 50,
            max: 30000,
            step: 10,
            label: "Speed min (ms)",
            render: (get) => get("Reveal.revealType") === "detonation",
          },
          revealDetonationSpeedMaxMs: {
            value: d.reveal.detonation.speedMaxMs,
            min: 50,
            max: 30000,
            step: 10,
            label: "Speed max (ms)",
          ...
          revealDetonationStaggerMs: {
            value: d.reveal.detonation.staggerMs,
            min: 0,
            max: 30000,
            step: 10,
            label: "Stagger (ms)",
          ...
          revealDetonationIntensity: {
            value: d.reveal.detonation.intensity,
            min: 0,
            max: 2,
            step: 0.05,
            label: "Intensity",
          ...
          revealDetonationDetail: {
            value: d.reveal.detonation.detail,
            min: 0,
            max: 1,
            step: 0.05,
            label: "Detail",
          ...
          revealDetonationGlow: {
            value: d.reveal.detonation.glow,
            min: 0,
            max: 1,
            step: 0.05,
            label: "Glow",
  ...
  const config = normalizeEngineConfig({
    ...
    reveal: {
      ...
      fluid: {
        speedMinMs: values.revealFluidSpeedMinMs,
        speedMaxMs: values.revealFluidSpeedMaxMs,
        staggerMs: values.revealFluidStaggerMs,
        intensity: values.revealFluidIntensity,
        detail: values.revealFluidDetail,
        glow: values.revealFluidGlow,
      },
      storm: {
        speedMinMs: values.revealStormSpeedMinMs,
        speedMaxMs: values.revealStormSpeedMaxMs,
        staggerMs: values.revealStormStaggerMs,
        intensity: values.revealStormIntensity,
        detail: values.revealStormDetail,
        glow: values.revealStormGlow,
      },
      detonation: {
        speedMinMs: values.revealDetonationSpeedMinMs,
        speedMaxMs: values.revealDetonationSpeedMaxMs,
        staggerMs: values.revealDetonationStaggerMs,
        intensity: values.revealDetonationIntensity,
        detail: values.revealDetonationDetail,
        glow: values.revealDetonationGlow,
      },
    },
    sparkle: {
      gaps: {
