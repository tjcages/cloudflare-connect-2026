...
export function useEngineControls(
    ...
    () =>
      orderShaderPanel({
        ...
        Reveal: drawerFolder("Reveal", {
          ...
          revealInkSpeedMinMs: {
            value: d.reveal.ink.speedMinMs,
            min: 50,
            max: 30000,
            step: 10,
            label: "Speed min (ms)",
            render: (get) => get("Reveal.revealType") === "ink",
          },
          revealInkSpeedMaxMs: {
            value: d.reveal.ink.speedMaxMs,
            min: 50,
            max: 30000,
            step: 10,
            label: "Speed max (ms)",
          ...
          revealTraceSpeedMinMs: {
            value: d.reveal.trace.speedMinMs,
            min: 50,
            max: 30000,
            step: 10,
            label: "Speed min (ms)",
            render: (get) => get("Reveal.revealType") === "trace",
          },
          revealTraceSpeedMaxMs: {
            value: d.reveal.trace.speedMaxMs,
            min: 50,
            max: 30000,
            step: 10,
            label: "Speed max (ms)",
          ...
          revealTraceStaggerMs: {
            value: d.reveal.trace.staggerMs,
            min: 0,
            max: 30000,
            step: 10,
            label: "Stagger (ms)",
          ...
          revealTraceIntensity: {
            value: d.reveal.trace.intensity,
            min: 0,
            max: 2,
            step: 0.05,
            label: "Intensity",
          ...
          revealPulseSpeedMinMs: {
            value: d.reveal.pulse.speedMinMs,
            min: 50,
            max: 30000,
            step: 10,
            label: "Speed min (ms)",
            render: (get) => get("Reveal.revealType") === "pulse",
          },
          revealPulseSpeedMaxMs: {
            value: d.reveal.pulse.speedMaxMs,
            min: 50,
            max: 30000,
            step: 10,
            label: "Speed max (ms)",
          ...
          revealPulseStaggerMs: {
            value: d.reveal.pulse.staggerMs,
            min: 0,
            max: 30000,
            step: 10,
            label: "Stagger (ms)",
          ...
          revealPulseIntensity: {
            value: d.reveal.pulse.intensity,
            min: 0,
            max: 2,
            step: 0.05,
            label: "Intensity",
  ...
  const config = normalizeEngineConfig({
    ...
    reveal: {
      ...
      ink: {
        speedMinMs: values.revealInkSpeedMinMs,
        speedMaxMs: values.revealInkSpeedMaxMs,
        staggerMs: values.revealInkStaggerMs,
        intensity: values.revealInkIntensity,
        detail: values.revealInkDetail,
        glow: values.revealInkGlow,
      },
      trace: {
        speedMinMs: values.revealTraceSpeedMinMs,
        speedMaxMs: values.revealTraceSpeedMaxMs,
        staggerMs: values.revealTraceStaggerMs,
        intensity: values.revealTraceIntensity,
        detail: values.revealTraceDetail,
        glow: values.revealTraceGlow,
      },
      pulse: {
        speedMinMs: values.revealPulseSpeedMinMs,
        speedMaxMs: values.revealPulseSpeedMaxMs,
        staggerMs: values.revealPulseStaggerMs,
        intensity: values.revealPulseIntensity,
        detail: values.revealPulseDetail,
        glow: values.revealPulseGlow,
      },
    },
    sparkle: {
      gaps: {
