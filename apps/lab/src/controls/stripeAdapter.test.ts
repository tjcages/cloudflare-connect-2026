...
describe("stripeAdapter", () => {
  it("round-trips color, startFrom, and width", () => {
    const stripes: Stripe[] = [
      ...
      { color: 0x000000, startFrom: 0, width: 1 },
      { color: 0xffffff, startFrom: 0.5, width: 64 },
    ];
