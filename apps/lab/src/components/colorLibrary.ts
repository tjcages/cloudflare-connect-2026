...
export const COLOR_LIBRARY: LibraryGroup[] = [
  ...
  colorGroup("Orange", [
    ...
    ["700 [Main]", "#ff6721", "color(display-p3 1.0000 0.4039 0.1294)", "oklch(0.702 0.214 41.4)"],
    ["650 [Secondary]", "#fab83b", "color(display-p3 0.9804 0.7216 0.2314)", "oklch(0.825 0.176 76.57)"],
