...
function LabInner({
  ...
  const sourcePreviewOpacity = rawSourceDebug || surfaceWorkspace.mode === "partial" ? 1 : backgroundSourceOpacity;
            ...
            <div className="lab-canvas-stage">
              ...
              >
                ...
                <canvas
                  ...
                  style={{
                    display: "block",
                    opacity: rawSourceDebug || surfaceWorkspace.mode === "partial" ? 0 : 1,
                    width: canvasCssSize.cssW,
                    height: canvasCssSize.cssH,
                  }}
                />
