...
- Defaults: color Orange Accent `#f46021` (COLOR_LIBRARY), 56 layers, base width `2.30`, perspective width `6.2`, width range `3.5–24.1`, Rotate X/Y/Z = 12° / −18° / 0°, animated `speed: 1`.
