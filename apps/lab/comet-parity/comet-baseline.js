...
function ne(e) {
  ...
  if (M()) {
    let e = t;
    ("drawingBufferColorSpace" in t && (e.drawingBufferColorSpace = "display-p3"),
      "unpackColorSpace" in t && (e.unpackColorSpace = "display-p3"),
      (n = (e.drawingBufferColorSpace ?? "srgb") === "display-p3"));
  }
...
function re(e, t) {
  ...
  return {
    ...
    detachContextLossListeners() {
      (n && e.removeEventListener("webglcontextlost", n),
        r && e.removeEventListener("webglcontextrestored", r),
        (n = null),
        (r = null));
    },
    supportsRaf: !0,
...
function P(e, t, n) {
  ...
  let i = N(e, e.VERTEX_SHADER, t),
    a = N(e, e.FRAGMENT_SHADER, n);
  if (
    (e.attachShader(r, i),
    e.attachShader(r, a),
    e.linkProgram(r),
...
function ge(e, t, n, r, i, a) {
  ...
  let o = a ? e.RGBA32F : i ? e.RGBA16F : e.RGBA8,
    s = a ? e.FLOAT : i ? e.HALF_FLOAT : e.UNSIGNED_BYTE;
...
function R(e, t, n, r = {}) {
  ...
  if ((e.bindFramebuffer(e.FRAMEBUFFER, null), s !== e.FRAMEBUFFER_COMPLETE))
...
function _e(e, t, n, r) {
  (t.width === n && t.height === r) ||
    (ge(e, t.texture, n, r, t.float ?? !1, t.float32 ?? !1), (t.width = n), (t.height = r));
}
function ve(e, t) {
  (e.deleteFramebuffer(t.fbo), e.deleteTexture(t.texture));
}
function z(e, t) {
  (e.bindFramebuffer(e.FRAMEBUFFER, t ? t.fbo : null),
    t && (e.viewport(0, 0, t.width, t.height), me(t.width, t.height)));
}
function ye(e) {
  ...
  return {
    render(r, a, o) {
      (z(e, r),
        ...
        e.uniform1i(i.src, 0),
        e.uniform4f(i.rect, o.srcRect.u0, o.srcRect.v0, o.srcRect.u1, o.srcRect.v1),
        e.uniform2f(i.texel, o.sourceTexelW, o.sourceTexelH));
      let s = o.adjustments;
      (e.uniform3f(i.bg, ...V(o.background)),
        e.uniform1f(i.blur, s.blurRadius),
        e.uniform1f(i.sharpen, s.sharpenAmount),
        e.uniform1f(i.black, s.blackPoint),
        e.uniform1f(i.white, s.whitePoint),
        e.uniform1f(i.gamma, s.gamma),
        e.uniform1f(i.exposure, s.exposure),
        e.uniform1f(i.contrast, s.contrast),
        e.uniform1f(i.brightThresh, s.brightness + s.thresholdBias),
        e.uniform1f(i.invert, +!!s.invert),
        e.uniform1f(i.posterize, s.posterizeLevels),
        e.uniform1f(i.noise, s.noiseAmount),
        e.activeTexture(e.TEXTURE1),
        e.bindTexture(e.TEXTURE_2D, o.water ? o.water.texture : a),
        e.uniform1i(i.water, 1),
        e.uniform1f(i.waterGain, o.water ? o.water.gain : 0),
        e.uniform2f(i.waterTexel, o.water ? o.water.texelX : 1, o.water ? o.water.texelY : 1),
        e.activeTexture(e.TEXTURE0),
        t.draw());
    },
    dispose() {
  ...
  return {
    render(r, a, o, s, c) {
      (be(e, r, [a, o]),
        ...
        e.uniform1i(i.src, 0),
        e.uniform4f(i.rect, c.srcRect.u0, c.srcRect.v0, c.srcRect.u1, c.srcRect.v1),
        e.uniform2f(i.texel, c.sourceTexelW, c.sourceTexelH));
      let l = c.adjustments;
      (e.uniform3f(i.bg, ...V(c.background)),
        e.uniform3f(i.colorBg, ...V(c.colorBackground)),
        e.uniform1f(i.maxColorDist, c.maxColorDist),
        e.uniform1f(i.blur, l.blurRadius),
        e.uniform1f(i.sharpen, l.sharpenAmount),
        e.uniform1f(i.black, l.blackPoint),
        e.uniform1f(i.white, l.whitePoint),
        e.uniform1f(i.gamma, l.gamma),
        e.uniform1f(i.exposure, l.exposure),
        e.uniform1f(i.contrast, l.contrast),
        e.uniform1f(i.brightThresh, l.brightness + l.thresholdBias),
        e.uniform1f(i.invert, +!!l.invert),
        e.uniform1f(i.posterize, l.posterizeLevels),
        e.uniform1f(i.noise, l.noiseAmount),
        t.draw());
    },
    dispose() {
      e.deleteProgram(n);
...
function Oe(e, t) {
  let n = P(e, B, De),
    r = e.getUniformLocation(n, "uField"),
    i = e.getUniformLocation(n, "uEdgeMaskEnabled"),
    a = e.getUniformLocation(n, "uEdgeMaskStart"),
    o = e.getUniformLocation(n, "uEdgeMaskEnd"),
    s = e.getUniformLocation(n, "uEdgeMaskPower"),
    c = e.getUniformLocation(n, "uEdgeMaskSides");
  return {
    render(l, u, d, f, p, m = 0, h = 0) {
      (e.bindFramebuffer(e.FRAMEBUFFER, null),
        ...
        e.uniform1i(r, 0),
        e.uniform1f(i, +!!p),
        e.uniform1f(a, f.start),
        e.uniform1f(o, f.end),
        e.uniform1f(s, f.power),
        e.uniform4f(c, +!!f.sides.left, +!!f.sides.right, +!!f.sides.bottom, +!!f.sides.top),
        t.draw());
    },
    dispose() {
      e.deleteProgram(n);
...
function ke(e, t) {
  let n = P(e, B, le),
    r = e.getUniformLocation(n, "uField"),
    i = e.getUniformLocation(n, "uGridCount");
  return {
    render(a, o, s, c) {
      (z(e, a),
        e.useProgram(n),
  ...
  return {
    render(r, a, o, s, c) {
      (z(e, r),
        ...
        e.activeTexture(e.TEXTURE0),
        e.bindTexture(e.TEXTURE_2D, a),
        e.uniform1i(i.field, 0),
        e.uniform2f(i.grid, o, s),
        e.uniform1f(i.mode, c.revealMode),
        e.uniform2f(i.origin, c.origin[0], c.origin[1]),
        e.uniform1f(i.maxDist, c.maxDist),
        e.uniform1f(i.progress, c.progress),
        e.uniform1f(i.softness, c.softness),
        e.uniform1f(i.waviness, c.waviness),
        e.uniform1f(i.bandRamp, c.bandRamp),
        t.draw());
    },
    dispose() {
      e.deleteProgram(n);
...
function Ie(e) {
  ...
  let r = (n) => e.getUniformLocation(t, n),
    i = {
      field: r("uField"),
  ...
  return {
    render(r, a, o, s, c, l) {
      (z(e, r),
        ...
        e.activeTexture(e.TEXTURE1),
        e.bindTexture(e.TEXTURE_2D, o),
        e.uniform1i(i.blurQuarter, 1),
        e.activeTexture(e.TEXTURE2),
        e.bindTexture(e.TEXTURE_2D, s),
        e.uniform1i(i.blurHalf, 2),
        e.activeTexture(e.TEXTURE3),
        e.bindTexture(e.TEXTURE_2D, c),
        e.uniform1i(i.blurFull, 3),
        e.activeTexture(e.TEXTURE0),
        e.uniform2f(i.blockGrid, l.blockCols, l.blockRows),
        e.uniform1f(i.progress, l.progress),
        e.uniform1f(i.spread, l.spread),
        e.uniform1f(i.flight, l.flight),
        e.uniform1f(i.spawnDist, l.spawnDist),
        e.uniform2f(i.scatter, l.scatter[0], l.scatter[1]),
        e.uniform1f(i.angleJitter, l.angleJitter),
        e.uniform2f(i.sigmaUv, l.sigmaUv[0], l.sigmaUv[1]),
        e.uniform1f(i.blurStart, l.blurStart),
        e.enable(e.BLEND),
        e.blendEquation(e.MAX),
        e.bindVertexArray(n),
        e.drawArraysInstanced(e.TRIANGLES, 0, 6, l.blockCols * l.blockRows),
  ...
  return {
    render(r, a, o) {
      (z(e, r),
        ...
        e.bindTexture(e.TEXTURE_2D, a),
        e.uniform1i(i.field, 0),
        e.uniform1i(i.mode, o.mode),
        e.uniform1f(i.progress, o.progress),
        e.uniform1f(i.spread, o.spread),
        e.uniform1f(i.flight, o.flight),
        e.uniform1f(i.intensity, o.intensity),
        e.uniform1f(i.detail, o.detail),
        e.uniform1f(i.glow, o.glow),
        t.draw());
    },
    dispose() {
      e.deleteProgram(n);
...
function Ve(e, t) {
  let n = P(e, B, ze),
    r = P(e, Be, W),
    i = e.createVertexArray();
  if (!i) throw Error("Failed to create VAO");
  let a = (t) => e.getUniformLocation(n, t),
    o = {
      field: a("uField"),
  ...
  return {
    render(a, s, l) {
      (z(e, a),
        ...
        e.bindTexture(e.TEXTURE_2D, s),
        e.useProgram(n),
        e.uniform1i(o.field, 0),
        e.uniform1f(o.progress, l.progress),
        e.uniform1f(o.spread, l.spread),
        e.uniform1f(o.flight, l.flight),
        e.uniform2f(o.grid, l.gridX, l.gridY),
        e.uniform1f(o.glow, l.glow),
        e.uniform1f(o.aspect, l.aspect),
        t.draw(),
        l.progress < l.spread + l.flight &&
          (e.useProgram(r),
          e.activeTexture(e.TEXTURE0),
          e.bindTexture(e.TEXTURE_2D, s),
          e.uniform1i(c.field, 0),
          e.uniform1f(c.progress, l.progress),
          e.uniform1f(c.spread, l.spread),
          e.uniform1f(c.flight, l.flight),
          e.uniform2f(c.grid, l.gridX, l.gridY),
          e.uniform1f(c.glow, l.glow),
          e.uniform1f(c.intensity, l.intensity),
          e.uniform1f(c.swirl, l.swirl),
          e.uniform1f(c.aspect, l.aspect),
          e.enable(e.BLEND),
          e.blendEquation(e.MAX),
          e.bindVertexArray(i),
          e.drawArraysInstanced(e.TRIANGLES, 0, 6, Math.max(1, Math.floor(l.count))),
          e.bindVertexArray(null),
          e.blendEquation(e.FUNC_ADD),
          e.disable(e.BLEND)));
    },
  ...
  return {
    render(a, s, l) {
      (z(e, a),
        ...
        e.uniform1i(o.field, 0),
        e.uniform1f(o.progress, l.progress),
        e.uniform1f(o.form, l.form),
        e.uniform1f(o.spread, l.spread),
        e.uniform1f(o.flightMin, l.flightMin),
        e.uniform1f(o.flightMax, l.flightMax),
        e.uniform1f(o.collapse, l.collapse),
        e.uniform2f(o.grid, l.gridX, l.gridY),
        e.uniform1f(o.glow, l.glow),
        e.uniform1f(o.swirl, l.swirl),
        e.uniform1f(o.arms, l.arms),
        e.uniform1f(o.lens, l.lensing),
        e.uniform1f(o.horizon, l.horizon),
        e.uniform1f(o.aspect, l.aspect),
        t.draw(),
        l.progress < 1 &&
          (e.useProgram(r),
          ...
          e.uniform1i(c.field, 0),
          e.uniform1f(c.progress, l.progress),
          e.uniform1f(c.form, l.form),
          e.uniform1f(c.spread, l.spread),
          e.uniform1f(c.flightMin, l.flightMin),
          e.uniform1f(c.flightMax, l.flightMax),
          e.uniform1f(c.collapse, l.collapse),
          e.uniform2f(c.grid, l.gridX, l.gridY),
          e.uniform1f(c.glow, l.glow),
          e.uniform1f(c.swirl, l.swirl),
          e.uniform1f(c.arms, l.arms),
          e.uniform1f(c.horizon, l.horizon),
          e.uniform1f(c.intensity, l.intensity),
          e.uniform1f(c.aspect, l.aspect),
          e.uniform1f(c.diskCount, l.diskCount),
          e.enable(e.BLEND),
          e.blendEquation(e.MAX),
          e.bindVertexArray(i),
          e.drawArraysInstanced(e.TRIANGLES, 0, 6, Math.max(1, Math.floor(l.count))),
  ...
  return {
    render(r, a, o) {
      (z(e, r),
        ...
        e.uniform1i(i.field, 0),
        e.uniform1f(i.progress, o.progress),
        e.uniform1f(i.turns, o.turns),
        e.uniform1f(i.tightness, o.tightness),
        e.uniform1f(i.streak, o.streak),
        e.uniform1f(i.glow, o.glow),
        e.uniform1f(i.aspect, o.aspect),
        t.draw());
    },
    dispose() {
      e.deleteProgram(n);
  ...
  return {
    render(r, a, o, s) {
      if (
        ...
        (e.activeTexture(e.TEXTURE1),
          e.bindTexture(e.TEXTURE_2D, a),
          e.uniform1i(i.cover, 1),
          e.activeTexture(e.TEXTURE2),
          e.bindTexture(e.TEXTURE_2D, a),
          e.uniform1i(i.height, 2),
          e.uniform1f(i.active, 0),
          t.draw(),
          e.bindFramebuffer(e.FRAMEBUFFER, null));
        return;
      }
      (e.activeTexture(e.TEXTURE1),
        e.bindTexture(e.TEXTURE_2D, o.cover),
        e.uniform1i(i.cover, 1),
        e.activeTexture(e.TEXTURE2),
        e.bindTexture(e.TEXTURE_2D, o.height),
        e.uniform1i(i.height, 2),
        e.uniform2f(i.heightTexel, o.texelX, o.texelY),
        e.uniform1f(i.refraction, s.refraction),
        e.uniform1f(i.whiteK, s.whiteK),
        e.uniform1f(i.glow, s.glow),
        e.uniform1f(i.fade, s.fade),
        e.uniform1f(i.active, 1),
        t.draw(),
        e.bindFramebuffer(e.FRAMEBUFFER, null));
    },
    dispose() {
...
function Xe(e, t) {
  let n = P(e, B, Ye),
    r = e.getUniformLocation(n, "uTex"),
    i = e.getUniformLocation(n, "uStep");
  function a(a, o, s, c) {
    (z(e, o),
      e.useProgram(n),
      e.activeTexture(e.TEXTURE0),
...
function tt(e, t, n, r, i) {
  (e.activeTexture(e.TEXTURE0 + 0),
    ...
    e.uniform1i(t.cell, 0),
    e.activeTexture(e.TEXTURE0 + 1),
    e.bindTexture(e.TEXTURE_2D, i),
    e.uniform1i(t.lut, 1),
    e.activeTexture(e.TEXTURE0 + 5),
    e.bindTexture(e.TEXTURE_2D, n.opacityTex),
    e.uniform1i(t.opacityLut, 5),
    e.activeTexture(e.TEXTURE0 + 4),
    e.bindTexture(e.TEXTURE_2D, n.cellColorTex),
    e.uniform1i(t.cellColor, 4),
    e.uniform2f(t.grid, n.cols, n.rows),
    e.uniform2f(t.cellPx, n.cellW, n.cellH),
    e.uniform1f(t.cellMin, n.cellMin),
    e.uniform1f(t.cellMax, n.cellMax),
    e.uniform1f(t.timeSec, n.timeSec),
    e.uniform1f(t.gapEnabled, +!!n.gapEnabled),
    e.uniform1f(t.gapCoverage, n.gapCoverage),
    e.uniform1f(t.gapPeriodMin, n.gapPeriodMin),
    e.uniform1f(t.gapPeriodMax, n.gapPeriodMax),
    e.uniform1f(t.stripeSparkleEnabled, +!!n.stripeSparkleEnabled),
    e.uniform1f(t.stripeSparkleCoverage, n.stripeSparkleCoverage),
    e.uniform1f(t.stripeSparkleMaxBrightness, n.stripeSparkleMaxBrightness),
    e.uniform1f(t.stripeSparkleSpeed, n.stripeSparkleSpeed),
    e.uniform1f(t.stripeSparkleMinWidthPx, n.stripeSparkleMinWidthPx),
    e.uniform1f(t.stripeSparkleHueDriftDeg, n.stripeSparkleHueDriftDeg),
    e.uniform1f(t.stripeSparkleSaturationBoost, n.stripeSparkleSaturationBoost),
    e.uniform1f(t.shuffleEnabled, +!!n.shuffleEnabled),
    e.uniform1f(t.shuffleCoverage, n.shuffleCoverage),
    e.uniform1f(t.shufflePeriodMin, n.shufflePeriodMin),
    e.uniform1f(t.shufflePeriodMax, n.shufflePeriodMax),
    e.uniform1f(t.shuffleSwingPx, n.shuffleSwingPx),
    e.uniform1f(t.motionEnabled, +!!n.motionEnabled),
    e.uniform1f(t.motionAmplitudePx, n.motionAmplitudePx),
    e.uniform1f(t.motionStaggerPx, n.motionStaggerPx),
    e.uniform1f(t.motionMaxOffsetPx, n.motionMaxOffsetPx),
    e.uniform1f(t.motionSpeed, n.motionSpeed),
    e.uniform1f(t.useCellColors, +!!n.useCellColors),
    e.uniform1f(t.imageColorLightness, n.imageColorLightness),
    e.uniform1f(t.imageColorDensity, n.imageColorDensity),
    e.uniform1f(t.gradientEnabled, +!!n.gradientEnabled),
    e.uniform1f(t.gradientDirection, n.gradientDirection),
    e.uniform1f(t.gradientStopCount, n.gradientStopCount),
    e.uniform3f(t.gradientStop0, ...V(n.gradientStops[0])),
    e.uniform3f(t.gradientStop1, ...V(n.gradientStops[1])),
    e.uniform3f(t.gradientStop2, ...V(n.gradientStops[2])),
    e.uniform3f(t.gradientStop3, ...V(n.gradientStops[3])),
    e.uniform1f(t.gradientHueDriftDeg, n.gradientHueDriftDeg),
    e.uniform1f(t.gradientSaturationBoost, n.gradientSaturationBoost));
}
//#endregion
//#region src/passes/stripePass.ts
function nt(e, t) {
  let n = Math.max(0.05, e.sparkle.gaps.speed);
  return {
    ...
    stripeSparkleMinWidthPx: (() => {
      let t = Array.from(
        new Set(
          e.stripes.filter((e) => e.opacity > 0.001 && e.width >= 0.5).map((e) => Math.round(e.width * 1e3) / 1e3),
        ),
      ).sort((e, t) => t - e);
...
function rt(e, t) {
  ...
  return {
    render(r, s, c, l, u, d = null, f = 0, p = 0) {
      (d ? z(e, d) : (e.bindFramebuffer(e.FRAMEBUFFER, null), e.viewport(f, p, l, u), me(l, u)),
        e.useProgram(n),
        tt(e, i, c, r, s));
      let m = !!c.cellDataA && !!c.cellDataB;
      (e.uniform1f(a.useCellData, +!!m),
        m &&
          (e.activeTexture(e.TEXTURE6),
          e.bindTexture(e.TEXTURE_2D, c.cellDataA),
          e.uniform1i(a.cellDataA, 6),
          e.activeTexture(e.TEXTURE7),
          e.bindTexture(e.TEXTURE_2D, c.cellDataB),
          e.uniform1i(a.cellDataB, 7)),
        e.uniform2f(a.gridGap, c.gapX, c.gapY),
        e.uniform1f(a.corner, c.cornerRadius),
        e.uniform1f(a.orient, c.orientation),
        e.uniform1f(a.angleDeg, c.angleDeg),
        e.uniform1f(a.rotationMode, c.rotationMode),
        e.uniform1f(a.overlapAmount, c.overlapAmount),
        e.uniform1f(a.streamGapWaveEnabled, +!!c.streamGapWaveEnabled),
        e.uniform1f(a.streamGapWaveSqueeze, c.streamGapWaveSqueeze),
        e.uniform1f(a.streamGapWaveWavelengthCells, c.streamGapWaveWavelengthCells),
        e.uniform1f(a.streamGapWaveSpeed, c.streamGapWaveSpeed),
        e.uniform1f(a.streamGapWavePhaseDeg, c.streamGapWavePhaseDeg),
        o(a.bg, c.background),
        e.uniform1f(a.bgAlpha, c.backgroundAlpha),
        e.uniform1f(a.transparent, +!!c.transparent),
        e.uniform1f(a.bgGradientEnabled, +!!c.backgroundGradientEnabled),
        e.uniform1f(a.bgGradientDirection, c.backgroundGradientDirection),
        e.uniform1f(a.bgGradientStopCount, c.backgroundGradientStopCount),
        o(a.bgGradientStop0, c.backgroundGradientStops[0]),
        o(a.bgGradientStop1, c.backgroundGradientStops[1]),
        o(a.bgGradientStop2, c.backgroundGradientStops[2]),
        o(a.bgGradientStop3, c.backgroundGradientStops[3]),
        e.uniform1f(a.bgGridEnabled, +!!c.backgroundGridEnabled),
        e.uniform2f(a.bgGridCellPx, c.backgroundGridCellW, c.backgroundGridCellH),
        e.uniform2f(a.bgGridGapPx, c.backgroundGridGapX, c.backgroundGridGapY),
        e.uniform1f(a.bgGridCorner, c.backgroundGridCornerRadius),
        o(a.bgGridColor, c.backgroundGridColor),
        e.uniform1f(a.bgGridOpacity, c.backgroundGridOpacity),
        e.uniform2f(a.displayPx, c.displayW, c.displayH),
        e.uniform1f(a.dpr, c.dpr),
        e.uniform1f(a.stripeDotsEnabled, +!!c.stripeDotsEnabled),
        e.uniform1f(a.stripeDotsSizePx, c.stripeDotsSizePx),
        e.uniform1f(a.stripeDotsRandomVisibility, c.stripeDotsRandomVisibility),
        e.uniform1f(a.stripeDotsBrightness, c.stripeDotsBrightness),
        e.uniform1f(a.stripeDotsHueDriftDeg, c.stripeDotsHueDriftDeg),
        e.uniform1f(a.stripeDotsSaturationBoost, c.stripeDotsSaturationBoost),
        e.uniform1f(a.stripeBorderEnabled, +!!c.stripeBorderEnabled),
        e.uniform1f(a.stripeBorderMinWidthPx, c.stripeBorderMinWidthPx),
        e.uniform1f(a.stripeBorderDensity, c.stripeBorderDensity),
        e.uniform1f(a.gridLinesEnabled, +!!c.gridLinesEnabled),
        e.uniform1f(a.gridLinesBrightness, c.gridLinesBrightness),
        e.uniform1f(a.gridLinesDensity, c.gridLinesDensity),
        e.uniform1f(a.edgeMaskEnabled, +!!c.edgeMaskEnabled),
        e.uniform1f(a.edgeMaskStart, c.edgeMaskStart),
        e.uniform1f(a.edgeMaskEnd, c.edgeMaskEnd),
        e.uniform1f(a.edgeMaskPower, c.edgeMaskPower),
        e.uniform4f(a.edgeMaskSides, ...c.edgeMaskSides),
        e.uniform1f(a.lettersEnabled, +!!c.lettersEnabled),
        e.activeTexture(e.TEXTURE2),
        e.bindTexture(e.TEXTURE_2D, c.glyphDataTex),
        e.uniform1i(a.glyphData, 2),
        e.activeTexture(e.TEXTURE3),
        e.bindTexture(e.TEXTURE_2D, c.atlasTex),
        e.uniform1i(a.atlas, 3),
        e.uniform2f(a.atlasGrid, c.atlasGrid[0], c.atlasGrid[1]),
        e.uniform1f(a.letterSizeScale, c.letterSizeScale),
        o(a.letterColor, c.letterColor),
        e.uniform1f(a.blendMode, c.blendMode),
        t.draw());
    },
    dispose() {
      e.deleteProgram(n);
...
function xt(e, t) {
  ...
  return {
    render(n, i, a, o, s = 0, c = 0) {
      let l = r(o.mode);
      (z(e, n),
        n || (e.viewport(s, c, o.resolution[0], o.resolution[1]), me(o.resolution[0], o.resolution[1])),
        e.useProgram(l.program),
        e.activeTexture(e.TEXTURE0),
        e.bindTexture(e.TEXTURE_2D, i),
        e.uniform1i(l.uTex, 0),
        e.activeTexture(e.TEXTURE1),
        e.bindTexture(e.TEXTURE_2D, a),
        e.uniform1i(l.uStripes, 1),
        e.uniform1f(l.uTime, o.time),
        e.uniform1f(l.uIntensity, o.intensity),
        e.uniform2f(l.uResolution, o.resolution[0], o.resolution[1]),
        e.uniform1f(l.uDpr, o.dpr),
        e.uniform4f(l.uParams, o.params[0], o.params[1], o.params[2], o.params[3]),
        e.uniform3f(l.uColorA, ...V(o.colorA)),
        e.uniform3f(l.uColorB, ...V(o.colorB)),
        t.draw());
    },
    dispose() {
...
function Ct(e, t) {
  let n = P(e, B, St),
    r = e.getUniformLocation(n, "uTex"),
    i = e.getUniformLocation(n, "uResolution"),
    a = e.getUniformLocation(n, "uBg");
  return {
    render(o, s, c) {
      (z(e, o),
        e.useProgram(n),
        ...
        e.bindTexture(e.TEXTURE_2D, s),
        e.uniform1i(r, 0),
        e.uniform2f(i, c.resolution[0], c.resolution[1]),
        e.uniform3f(a, ...V(c.bg)),
        t.draw());
    },
    dispose() {
      e.deleteProgram(n);
...
function Tt(e, t) {
  let n = P(e, B, wt),
    r = e.getUniformLocation(n, "uCell"),
    i = e.getUniformLocation(n, "uGridSize"),
    a = e.getUniformLocation(n, "uTopBandThreshold"),
    o = e.getUniformLocation(n, "uCoverage"),
    s = e.getUniformLocation(n, "uTimeSec"),
    c = e.getUniformLocation(n, "uCharsetLen"),
    l = e.getUniformLocation(n, "uShuffleSpeed"),
    u = e.getUniformLocation(n, "uPosition"),
    d = e.getUniformLocation(n, "uArea");
  return {
    render(f, p, m) {
      (z(e, f),
        e.useProgram(n),
        ...
        e.uniform1i(r, 0),
        e.uniform2f(i, m.cols, m.rows),
        e.uniform1f(a, m.topBandThreshold),
        e.uniform1f(o, m.coverage),
        e.uniform1f(s, m.timeSec),
        e.uniform1f(c, m.charsetLen),
        e.uniform1f(l, m.shuffleSpeed),
        e.uniform2f(u, m.positionX, m.positionY),
        e.uniform2f(d, m.areaWidth, m.areaHeight),
        t.draw());
    },
    dispose() {
      e.deleteProgram(n);
...
function Dt(e = {}) {
  let t = e.fontPx ?? 6,
    n = e.rasterScale ?? 8,
    r = e.fontFamily ?? "monospace",
    i = t * n,
    a = q.length,
    o = Math.ceil(Math.sqrt(a)),
    s = o,
    c = o,
    l = o * i,
    u = o * i,
  ...
  let f = d.getImageData(0, 0, l, u).data,
...
function Ot(e, t) {
  ...
  return (
    ...
    e.texParameteri(e.TEXTURE_2D, e.TEXTURE_WRAP_S, e.CLAMP_TO_EDGE),
    e.texParameteri(e.TEXTURE_2D, e.TEXTURE_WRAP_T, e.CLAMP_TO_EDGE),
    e.texImage2D(e.TEXTURE_2D, 0, e.R8, t.width, t.height, 0, e.RED, e.UNSIGNED_BYTE, t.data),
    n
  );
}
//#endregion
...
function It(e, t, n, r, i) {
  let a = new Uint8Array(e * t * 4),
    o = new Uint8Array(e * t),
    s = r.replace(/\r/g, "").split("\n"),
    c = s.reduce((e, t) => Math.max(e, [...t].length), 0),
    l = [],
    u = 0,
    d = 0;
  if (
    (s.forEach((e, t) => {
      ...
      e.length === 0 &&
        ((u = Math.max(u, n === "horizontal" ? 0 : t + 1)), (d = Math.max(d, n === "horizontal" ? t + 1 : 0)));
    }),
    ...
    for (let t of s) {
      ...
      let n = !0;
      for (let r of l)
        if (o[(t.row + r.row) * e + t.col + r.col]) {
          n = !1;
          break;
        }
      if (n) {
...
function Yt(e) {
  ...
  {
    let n = e.getAttribLocation(t, "aRect"),
      r = e.getAttribLocation(t, "aOpacity");
    (e.enableVertexAttribArray(n),
      e.vertexAttribPointer(n, 4, e.FLOAT, !1, s, 0),
      e.vertexAttribDivisor(n, 1),
      e.enableVertexAttribArray(r),
      e.vertexAttribPointer(r, 1, e.FLOAT, !1, s, 16),
  ...
  {
    let t = e.getAttribLocation(n, "aRect"),
      r = e.getAttribLocation(n, "aOpacity"),
      i = e.getAttribLocation(n, "aColor");
    (e.enableVertexAttribArray(t),
      e.vertexAttribPointer(t, 4, e.FLOAT, !1, c, 0),
      e.vertexAttribDivisor(t, 1),
      e.enableVertexAttribArray(r),
      e.vertexAttribPointer(r, 1, e.FLOAT, !1, c, 16),
      e.vertexAttribDivisor(r, 1));
    let a = e.getAttribLocation(n, "aRot");
    (e.enableVertexAttribArray(a),
      e.vertexAttribPointer(a, 1, e.FLOAT, !1, c, 20),
      e.vertexAttribDivisor(a, 1),
      e.enableVertexAttribArray(i),
      e.vertexAttribPointer(i, 3, e.FLOAT, !1, c, 24),
      e.vertexAttribDivisor(i, 1));
  }
  (e.bindVertexArray(null), e.bindBuffer(e.ARRAY_BUFFER, null));
  let l = e.getUniformLocation(t, "uCanvas"),
    u = e.getUniformLocation(t, "uVertical"),
    d = e.getUniformLocation(t, "uInner"),
    f = e.getUniformLocation(t, "uOuter"),
    p = e.getUniformLocation(n, "uCanvas"),
    m = e.getUniformLocation(n, "uVertical"),
    h = e.getUniformLocation(n, "uInner"),
    g = e.getUniformLocation(n, "uOuter"),
    _ = new Float32Array(),
    v = new Float32Array();
  function y(e) {
    let t = e.length * Gt;
  ...
  return {
    render(n, i, o) {
      ...
      (z(e, n),
        e.useProgram(t),
        e.uniform2f(l, o.canvasW, o.canvasH),
        e.uniform1f(u, +!!o.vertical),
        e.uniform1f(d, o.inner),
        e.uniform1f(f, o.outer),
        e.bindVertexArray(r),
        e.bindBuffer(e.ARRAY_BUFFER, a),
        e.bufferData(e.ARRAY_BUFFER, _.subarray(0, s), e.DYNAMIC_DRAW),
        e.bindBuffer(e.ARRAY_BUFFER, null),
        e.enable(e.BLEND),
        e.blendFunc(e.ONE, e.ONE),
        e.drawArraysInstanced(e.TRIANGLES, 0, 6, i.length),
        e.disable(e.BLEND),
        e.bindVertexArray(null));
    },
    renderColors(s, c, b, x, S) {
      if (b.length === 0) return;
      let C = Math.max(1, x.length),
        w = y(b);
      (z(e, s),
        e.useProgram(t),
        e.uniform2f(l, S.canvasW, S.canvasH),
        e.uniform1f(u, +!!S.vertical),
        e.uniform1f(d, S.inner),
        e.uniform1f(f, S.outer),
        e.bindVertexArray(r),
        e.bindBuffer(e.ARRAY_BUFFER, a),
        e.bufferData(e.ARRAY_BUFFER, _.subarray(0, w), e.DYNAMIC_DRAW),
        e.bindBuffer(e.ARRAY_BUFFER, null),
        e.enable(e.BLEND),
        e.blendFunc(e.ONE, e.ONE),
        e.drawArraysInstanced(e.TRIANGLES, 0, 6, b.length),
        e.bindVertexArray(null));
      let T = b.length * qt;
      ...
      for (let e = 0; e < b.length; e++) {
        let t = b[e],
          n = e * qt,
          r = x[Math.min(C - 1, Math.floor(t.colorSeed * C))];
        ((v[n] = t.x),
          (v[n + 1] = t.y),
          (v[n + 2] = t.width),
          (v[n + 3] = t.height),
      ...
      (z(e, c),
        e.useProgram(n),
        e.uniform2f(p, S.canvasW, S.canvasH),
        e.uniform1f(m, +!!S.vertical),
        e.uniform1f(h, S.inner),
        e.uniform1f(g, S.outer),
        e.bindVertexArray(i),
        e.bindBuffer(e.ARRAY_BUFFER, o),
        e.bufferData(e.ARRAY_BUFFER, v.subarray(0, T), e.DYNAMIC_DRAW),
        e.bindBuffer(e.ARRAY_BUFFER, null),
        e.enable(e.BLEND),
    ...
    dispose() {
      (e.deleteProgram(t),
        e.deleteProgram(n),
        e.deleteVertexArray(r),
        e.deleteVertexArray(i),
        e.deleteBuffer(a),
        e.deleteBuffer(o));
    },
  };
...
function sn(e) {
  ...
  (e.bindVertexArray(r), e.bindBuffer(e.ARRAY_BUFFER, a));
  {
    ...
    (e.enableVertexAttribArray(n),
      ...
      e.vertexAttribDivisor(r, 1),
      e.enableVertexAttribArray(i),
      e.vertexAttribPointer(i, 1, e.FLOAT, !1, s, 20),
      e.vertexAttribDivisor(i, 1));
  }
  let c = on;
  (e.bindVertexArray(i), e.bindBuffer(e.ARRAY_BUFFER, o));
  {
    let t = e.getAttribLocation(n, "aRect"),
      r = e.getAttribLocation(n, "aOpacity"),
      i = e.getAttribLocation(n, "aTilt"),
      a = e.getAttribLocation(n, "aColor");
    (e.enableVertexAttribArray(t),
      e.vertexAttribPointer(t, 4, e.FLOAT, !1, c, 0),
      e.vertexAttribDivisor(t, 1),
      e.enableVertexAttribArray(r),
      ...
      e.vertexAttribDivisor(r, 1),
      e.enableVertexAttribArray(i),
      e.vertexAttribPointer(i, 1, e.FLOAT, !1, c, 20),
      e.vertexAttribDivisor(i, 1),
      e.enableVertexAttribArray(a),
      e.vertexAttribPointer(a, 3, e.FLOAT, !1, c, 24),
      e.vertexAttribDivisor(a, 1));
  }
  (e.bindVertexArray(null), e.bindBuffer(e.ARRAY_BUFFER, null));
  let l = e.getUniformLocation(t, "uCanvas"),
    u = e.getUniformLocation(n, "uCanvas"),
    d = new Float32Array(),
    f = new Float32Array();
  function p(e) {
    let t = e.length * nn;
    ...
    for (let t = 0; t < e.length; t++) {
      let n = e[t],
        r = Math.max(0.001, n.sizePx * n.scale * tn),
        i = t * nn;
      ((d[i] = n.x - r * 0.5),
        (d[i + 1] = n.y - r * 0.5),
        (d[i + 2] = r),
  ...
  return {
    render(n, i, o) {
      ...
      (z(e, n),
        ...
        e.bindVertexArray(r),
        e.bindBuffer(e.ARRAY_BUFFER, a),
        e.bufferData(e.ARRAY_BUFFER, d.subarray(0, s), e.DYNAMIC_DRAW),
        e.bindBuffer(e.ARRAY_BUFFER, null),
        e.enable(e.BLEND),
        e.blendFunc(e.ONE, e.ONE),
        e.drawArraysInstanced(e.TRIANGLES, 0, 6, i.length),
    ...
    renderColors(s, c, m, h, g) {
      ...
      let _ = Math.max(1, h.length),
        v = p(m);
      (z(e, s),
        e.useProgram(t),
        e.uniform2f(l, g.canvasW, g.canvasH),
        e.bindVertexArray(r),
        e.bindBuffer(e.ARRAY_BUFFER, a),
        e.bufferData(e.ARRAY_BUFFER, d.subarray(0, v), e.DYNAMIC_DRAW),
        e.bindBuffer(e.ARRAY_BUFFER, null),
        e.enable(e.BLEND),
        e.blendFunc(e.ONE, e.ONE),
        e.drawArraysInstanced(e.TRIANGLES, 0, 6, m.length),
        e.bindVertexArray(null));
      let y = m.length * an;
      ...
      for (let e = 0; e < m.length; e++) {
        let t = m[e],
          n = Math.max(0.001, t.sizePx * t.scale * tn),
          r = e * an,
          i = h[Math.min(_ - 1, Math.floor(t.colorSeed * _))];
        ((f[r] = t.x - n * 0.5),
          (f[r + 1] = t.y - n * 0.5),
          (f[r + 2] = n),
          (f[r + 3] = n),
      ...
      (z(e, c),
        e.useProgram(n),
        e.uniform2f(u, g.canvasW, g.canvasH),
        e.bindVertexArray(i),
        e.bindBuffer(e.ARRAY_BUFFER, o),
        e.bufferData(e.ARRAY_BUFFER, f.subarray(0, y), e.DYNAMIC_DRAW),
        e.bindBuffer(e.ARRAY_BUFFER, null),
        e.enable(e.BLEND),
        e.blendFunc(e.ONE, e.ONE_MINUS_SRC_ALPHA),
        e.drawArraysInstanced(e.TRIANGLES, 0, 6, m.length),
...
function fn(e, t, n, r, i) {
  let a = Math.min(1, Math.max(0, t.sizeRandomness)),
    o = J(1 - a, 1 + a, e.random()),
    s = Math.max(0.05, t.twinkleSpeed),
    c = J(750, 2200, e.random()) / s,
    l = i ? r - e.random() * c : r;
  return {
    x: e.random() * n.width,
    y: e.random() * n.height,
    sizePx: Math.max(0.25, t.sizePx * Math.max(0.12, o)),
    scale: 0,
    tiltRad: 0,
    bornMs: l,
    lifeMs: c,
...
function pn(e, t, n) {
  ...
  let i = r / e.lifeMs,
    a = ln(0, 0.28, i) * (1 - ln(0.62, 1, i)),
    o = ln(0, 0.18, i) * (1 - ln(0.72, 1, i)),
    s = Math.max(0, t.twinkleSpeed),
    c = 0.5 + 0.5 * Math.sin((n / 1e3) * s * Math.PI * 2 + e.phase),
    l = Math.min(1, Math.max(0, t.twinkleAmount)),
    u = J(1, 0.78 + 0.22 * c, l),
    d = J(1, 0.65 + 0.35 * c, l),
    f = (Math.min(89, Math.max(-89, t.tiltAngleDeg)) * Math.PI) / 180;
  return (
    (e.scale = Math.min(1, Math.max(0, a * u))),
    (e.tiltRad = f),
    (e.opacity = Math.min(1, Math.max(0, t.opacity * e.baseOpacity * o * d))),
    (e.scale > 0.001 && e.opacity > 0.001) || i < 0.96
  );
}
function mn(e, t, n, r) {
  ...
  for (
    e.lastStepMs = r, e.stars = e.stars.filter((e) => pn(e, t, r)), e.stars.length > i && (e.stars.length = i);
    e.stars.length < i;
  ) {
    let i = fn(e, t, n, r, a);
...
function gn(e, t) {
  let n = P(e, B, hn),
    r = e.getUniformLocation(n, "uField"),
    i = e.getUniformLocation(n, "uStart"),
    a = e.getUniformLocation(n, "uEnd"),
    o = e.getUniformLocation(n, "uPower"),
    s = e.getUniformLocation(n, "uSides");
  return {
    render(c, l, u) {
      (z(e, c),
        e.useProgram(n),
        ...
        e.bindTexture(e.TEXTURE_2D, l),
        e.uniform1i(r, 0),
        e.uniform1f(i, u.start),
        e.uniform1f(a, u.end),
        e.uniform1f(o, u.power),
        e.uniform4f(s, +!!u.sides.left, +!!u.sides.right, +!!u.sides.bottom, +!!u.sides.top),
        t.draw());
    },
    dispose() {
      e.deleteProgram(n);
...
function Sn(e) {
  ...
  let i = e.getAttribLocation(t, "aCenterCell"),
    a = e.getAttribLocation(t, "aBrightenRadiusCell"),
    o = e.getAttribLocation(t, "aPushCenterCell"),
    s = e.getAttribLocation(t, "aPushRadiusCell"),
    c = e.getAttribLocation(t, "aAlpha"),
    l = e.getAttribLocation(t, "aProgress"),
    u = e.getAttribLocation(t, "aSeed"),
    d = e.getUniformLocation(t, "uGridSize"),
    f = e.getUniformLocation(t, "uPushScale");
  (e.bindVertexArray(n),
    e.bindBuffer(e.ARRAY_BUFFER, r),
    e.enableVertexAttribArray(i),
    e.vertexAttribPointer(i, 2, e.FLOAT, !1, bn, 0),
    e.vertexAttribDivisor(i, 1),
    e.enableVertexAttribArray(a),
    e.vertexAttribPointer(a, 1, e.FLOAT, !1, bn, 8),
    e.vertexAttribDivisor(a, 1),
    e.enableVertexAttribArray(o),
    e.vertexAttribPointer(o, 2, e.FLOAT, !1, bn, 12),
    e.vertexAttribDivisor(o, 1),
    e.enableVertexAttribArray(s),
    e.vertexAttribPointer(s, 1, e.FLOAT, !1, bn, 20),
    e.vertexAttribDivisor(s, 1),
    e.enableVertexAttribArray(c),
    e.vertexAttribPointer(c, 1, e.FLOAT, !1, bn, 24),
    e.vertexAttribDivisor(c, 1),
    e.enableVertexAttribArray(l),
    e.vertexAttribPointer(l, 1, e.FLOAT, !1, bn, 28),
    e.vertexAttribDivisor(l, 1),
    e.enableVertexAttribArray(u),
    e.vertexAttribPointer(u, 1, e.FLOAT, !1, bn, 32),
  ...
  return {
    render(i, a, o) {
      ...
      let s = o.displayWidth > 0 ? o.cols / o.displayWidth : 1,
        c = o.displayHeight > 0 ? o.rows / o.displayHeight : 1,
        l = o.displayWidth > 0 ? o.cols / o.displayWidth : 1,
        u = a.length * yn;
      ...
      for (let e = 0; e < a.length; e++) {
        let t = a[e],
          n = xn(t.alpha);
        if (n <= 0) continue;
        let r = Math.max(1, t.radius * l),
          i = Math.max(1, t.radius * o.pushRadiusScale * l),
          u = m * yn;
        ((p[u] = t.x * s),
          (p[u + 1] = t.y * c),
          (p[u + 2] = r),
      ...
      (e.useProgram(t),
        e.uniform2f(d, o.cols, o.rows),
        e.uniform1f(f, o.pushScale),
        e.bindVertexArray(n),
        e.bindBuffer(e.ARRAY_BUFFER, r),
        e.bufferData(e.ARRAY_BUFFER, p.subarray(0, m * yn), e.DYNAMIC_DRAW),
        e.bindBuffer(e.ARRAY_BUFFER, null),
        e.enable(e.BLEND),
        e.blendFunc(e.ONE, e.ONE),
        e.drawArraysInstanced(e.TRIANGLES, 0, 6, m),
        e.disable(e.BLEND),
        e.bindVertexArray(null));
    },
    dispose() {
...
function Tn(e, t) {
  let n = P(e, B, Cn),
    r = e.getUniformLocation(n, "uAccum"),
    i = e.getUniformLocation(n, "uTexel"),
    a = e.getUniformLocation(n, "uTearStrength"),
    o = e.getUniformLocation(n, "uPushCap");
  return {
    render(s, c, l) {
      (z(e, s),
        e.useProgram(n),
        ...
        e.bindTexture(e.TEXTURE_2D, c),
        e.uniform1i(r, 0),
        e.uniform2f(i, l.cols > 0 ? 1 / l.cols : 0, l.rows > 0 ? 1 / l.rows : 0),
        e.uniform1f(a, wn),
        e.uniform1f(o, l.pushCap),
        t.draw());
    },
    dispose() {
      e.deleteProgram(n);
...
function On(e, t) {
  let n = P(e, B, En),
    r = e.getUniformLocation(n, "uField"),
    i = e.getUniformLocation(n, "uAccum"),
    a = e.getUniformLocation(n, "uTear"),
    o = e.getUniformLocation(n, "uPixelSize"),
    s = e.getUniformLocation(n, "uCellSize"),
    c = e.getUniformLocation(n, "uGridSize"),
    l = e.getUniformLocation(n, "uPushCap"),
    u = P(e, B, Dn),
    d = e.getUniformLocation(u, "uFieldColor"),
    f = e.getUniformLocation(u, "uAccum"),
    p = e.getUniformLocation(u, "uTear"),
    m = e.getUniformLocation(u, "uPixelSize"),
    h = e.getUniformLocation(u, "uCellSize"),
    g = e.getUniformLocation(u, "uGridSize"),
    _ = e.getUniformLocation(u, "uPushCap"),
    v = e.getUniformLocation(u, "uTrailColor");
  function y(n, r, i, a, o, s, c, l) {
    (z(e, i),
      e.useProgram(n),
      e.activeTexture(e.TEXTURE0),
      e.bindTexture(e.TEXTURE_2D, a),
      e.uniform1i(r.field, 0),
      e.activeTexture(e.TEXTURE1),
      e.bindTexture(e.TEXTURE_2D, o),
      e.uniform1i(r.accum, 1),
      e.activeTexture(e.TEXTURE2),
      e.bindTexture(e.TEXTURE_2D, s),
      e.uniform1i(r.tear, 2),
      e.uniform2f(r.pixelSize, c.pixelW, c.pixelH),
      e.uniform2f(r.cellSize, c.cellW, c.cellH),
      e.uniform2f(r.gridSize, c.cols, c.rows),
      e.uniform1f(r.pushCap, c.pushCap),
      l && r.trailColor && e.uniform3f(r.trailColor, l[0], l[1], l[2]),
      t.draw(),
      e.activeTexture(e.TEXTURE0));
  }
  return {
...
function Mn(e) {
  ...
  if (!r) throw Error("Failed to create instance buffer");
  let i = e.getAttribLocation(t, "aCenterCell"),
    a = e.getAttribLocation(t, "aRadiusCell"),
    o = e.getAttribLocation(t, "aHalfStrokeCell"),
    s = e.getAttribLocation(t, "aPushBandCell"),
    c = e.getAttribLocation(t, "aPushPeak"),
    l = e.getAttribLocation(t, "aWhiteAmt"),
    u = e.getAttribLocation(t, "aProgress"),
    d = e.getAttribLocation(t, "aSeed"),
    f = e.getUniformLocation(t, "uGridSize");
  (e.bindVertexArray(n),
    e.bindBuffer(e.ARRAY_BUFFER, r),
    e.enableVertexAttribArray(i),
    e.vertexAttribPointer(i, 2, e.FLOAT, !1, Y, 0),
    e.vertexAttribDivisor(i, 1),
    e.enableVertexAttribArray(a),
    e.vertexAttribPointer(a, 1, e.FLOAT, !1, Y, 8),
    e.vertexAttribDivisor(a, 1),
    e.enableVertexAttribArray(o),
    e.vertexAttribPointer(o, 1, e.FLOAT, !1, Y, 12),
    e.vertexAttribDivisor(o, 1),
    e.enableVertexAttribArray(s),
    e.vertexAttribPointer(s, 1, e.FLOAT, !1, Y, 16),
    e.vertexAttribDivisor(s, 1),
    e.enableVertexAttribArray(c),
    e.vertexAttribPointer(c, 1, e.FLOAT, !1, Y, 20),
    e.vertexAttribDivisor(c, 1),
    e.enableVertexAttribArray(l),
    e.vertexAttribPointer(l, 1, e.FLOAT, !1, Y, 24),
    e.vertexAttribDivisor(l, 1),
    e.enableVertexAttribArray(u),
    e.vertexAttribPointer(u, 1, e.FLOAT, !1, Y, 28),
    e.vertexAttribDivisor(u, 1),
    e.enableVertexAttribArray(d),
    e.vertexAttribPointer(d, 1, e.FLOAT, !1, Y, 32),
    e.vertexAttribDivisor(d, 1),
    e.bindVertexArray(null),
    e.bindBuffer(e.ARRAY_BUFFER, null));
  let p = new Float32Array();
  return {
    render(i, a, o) {
      ...
      for (let e = 0; e < a.length; e++) {
        let t = a[e],
          n = Math.max(0, t.radius * l);
        if (n <= 0) continue;
        let r = t.whitePower * o.stripeWhiteAlpha,
          i = o.pushScale * t.pushPower;
        if (r <= 0 && i <= 0) continue;
        let u = Math.max(0.5, t.strokeWidth * 0.5 * l),
          f = Math.max(0.5, u * o.pushBandScale),
          m = d * jn;
        ((p[m] = t.x * s),
          (p[m + 1] = t.y * c),
          (p[m + 2] = n),
      ...
      d !== 0 &&
        (z(e, i),
        e.useProgram(t),
        e.uniform2f(f, o.cols, o.rows),
        e.bindVertexArray(n),
        e.bindBuffer(e.ARRAY_BUFFER, r),
        e.bufferData(e.ARRAY_BUFFER, p.subarray(0, d * jn), e.DYNAMIC_DRAW),
        e.bindBuffer(e.ARRAY_BUFFER, null),
        e.enable(e.BLEND),
        e.blendFunc(e.ONE, e.ONE),
        e.drawArraysInstanced(e.TRIANGLES, 0, 6, d),
        e.disable(e.BLEND),
        e.bindVertexArray(null));
    },
    dispose() {
...
function Xn(e) {
  ...
  return {
    ...
    maxLinks: t,
    maxPulses: Math.min(24, Math.max(4, Math.round(t * 0.42))),
  };
}
function Zn(e) {
  return {
...
function tr(e, t) {
  ...
  for (let r = 0; r < t; r++) {
    ...
    for (let o = 0; o < 40; o++) {
      ...
      if ((c > a && ((a = c), (t = o), (i = s)), c >= 0.115)) break;
    }
    let o = Math.round(t * 255),
      s = Math.round(i * 255);
    ((e.starsX[r] = o / 255),
      (e.starsY[r] = s / 255),
      (e.starBytes[r * 4] = o),
      (e.starBytes[r * 4 + 1] = s),
      (e.starBytes[r * 4 + 2] = Math.round(n() * 255)),
      (e.starBytes[r * 4 + 3] = Math.round(n() * 255)));
  }
...
function nr(e, t, n, r) {
  ...
  let h = (e, t) => f.get(e < t ? e * 1024 + t : t * 1024 + e),
    g = [],
    _ = /* @__PURE__ */ new Set(),
    v = (e) => {
      let t = [];
...
function ir(e, t, n, r, i, a, o) {
  ...
  s.lastPulse = a;
  let c = rr(n, s) / Math.max(1, e.pairDist),
    l = t.pulseDurationMs * (0.571 + 0.429 * Math.min(1, Math.max(0, c)));
  e.pulses.push({
    edge: r,
    from: i,
    start: a,
...
function ar(e, t, n, r, i, a, o) {
  ...
  n.incident[r]
    .filter((e) => e !== i)
    .filter((e) => n.edges[e].phase >= 0.42 && a - n.edges[e].lastPulse > s)
    .sort((e, t) => n.edges[t].phase - n.edges[e].phase)
    .slice(0, 2)
    .forEach((t, n) => {
      e.pending.push({
        edge: t,
...
function or(e, t, n) {
  ...
  for (let t = 0; t < e.starCount; t++) {
    ...
    e.starFlare[t] = i >= 0 && i < 1 ? (i < 0.14 ? Qn(i / 0.14) : 1 - $n((i - 0.14) / 0.86)) : 0;
  }
}
function sr(e, t, n, r) {
  n.edges.forEach((i, a) => {
    i.phase < Vn ||
      i.prevPhase >= Vn ||
      r - i.lastPulse < t.pulseCooldownMs ||
      ir(
        e,
        t,
        n,
        a,
        Math.hypot(n.sx[i.a] - e.smoothX, n.sy[i.a] - e.smoothY) <=
          Math.hypot(n.sx[i.b] - e.smoothX, n.sy[i.b] - e.smoothY)
          ? i.a
          : i.b,
        r,
        1,
  ...
  for (let i = e.pending.length - 1; i >= 0; i--) {
    let a = e.pending[i];
    r < a.at || (e.pending.splice(i, 1), n.edges[a.edge].phase >= 0.3 && ir(e, t, n, a.edge, a.from, r, a.hops));
  }
  for (let i = e.pulses.length - 1; i >= 0; i--) {
    ...
    if ((r - a.start) / a.duration >= 1) {
      ...
      o.phase >= 0.2 && ((e.flareStart[s] = r), ar(e, t, n, s, a.edge, r, a.hops + 1));
      continue;
    }
    o.phase <= 0.05 && e.pulses.splice(i, 1);
  }
}
function cr(e, t, n) {
  let r = 0;
  for (let i of e.pulses) {
    ...
    let a = t.edges[i.edge],
      o = Math.min(1, Math.max(0, (n - i.start) / i.duration)),
      s = i.from === a.a ? o : 1 - o,
      c =
        Qn(o / 0.12) * (1 - $n(Math.max(0, (o - 0.82) / 0.18))) * Math.min(1, a.phase * 1.4) * (i.hops > 1 ? 0.82 : 1);
    if (c < 0.01) continue;
    let l = r * 4,
      u = r * 2;
    ((e.pulseSegData[l] = e.starsX[a.a]),
      (e.pulseSegData[l + 1] = e.starsY[a.a]),
      (e.pulseSegData[l + 2] = e.starsX[a.b]),
      (e.pulseSegData[l + 3] = e.starsY[a.b]),
      (e.pulseFxData[u] = s),
      (e.pulseFxData[u + 1] = c),
      r++);
  }
...
function lr(e, t) {
  ...
  for (let t = 0; t < e.starCount; t++) {
    let r = e.starPeak[t],
      i = Math.min(1, Math.max(0, (e.starSum[t] - r) * 0.5)),
      a = Math.min(1, r * (1 + Ln * i));
    e.starAct[t] += (a - e.starAct[t]) * n;
  }
}
function ur(e) {
  for (let t = 0; t < e.caps.maxStars; t++) {
    let n = t < e.starCount ? e.starAct[t] : 0,
      r = t < e.starCount ? e.starFlare[t] : 0;
    ((e.starFxBytes[t * 4] = Math.round(Math.min(1, Math.max(0, n)) * 255)),
      (e.starFxBytes[t * 4 + 1] = Math.round(Math.min(1, Math.max(0, r)) * 255)));
  }
}
function dr(e, t, n, r, i, a) {
  ...
  let l = Math.abs(r - e.cssW) > 0.5 || Math.abs(i - e.cssH) > 0.5,
    u = Math.abs(e.pairDist - e.builtPairDist) > 0.5;
  r > 1 &&
    (l || u || !e.graph) &&
    ((e.cssW = r),
    (e.cssH = i),
    (e.builtPairDist = e.pairDist),
    (e.graph = nr(e, r, i, e.pairDist)),
    (e.pulses.length = 0),
    (e.pending.length = 0));
  let d = e.graph;
  if (!d) {
  ...
  let f = Math.max(1, e.linkRadius),
    p = Math.max(1, t.linkFormMs),
    m = Math.max(1, t.linkDissolveMs);
  for (let r of d.edges) {
    ...
    if (n && e.hasSmooth) {
      let t = d.sx[r.a],
        ...
        a = d.sx[r.b] - t,
        o = d.sy[r.b] - n,
        s = Math.max(a * a + o * o, 1e-4),
        c = Math.min(1, Math.max(0, ((e.smoothX - t) * a + (e.smoothY - n) * o) / s)),
        l = Math.hypot(t + a * c - e.smoothX, n + o * c - e.smoothY) / f;
      l < 1 && (i = Qn((1 - l) / 0.65));
    }
    ((r.prevPhase = r.phase),
      i > 0.02
        ? (r.activeSince < 0 && (r.activeSince = a),
          (r.env = i),
          a - r.activeSince > r.stagger && (r.phase = Math.min(1, r.phase + o / p)))
        : (r.activeSince >= 0 && ((r.activeSince = -1), (r.holdUntil = a + t.linkHoldMs)),
          a >= r.holdUntil && ((r.phase = Math.max(0, r.phase - o / m)), r.phase === 0 && (r.env = 0))));
  }
  if ((t.pulseEnabled ? sr(e, t, d, a) : ((e.pulses.length = 0), (e.pending.length = 0)), t.polygonFlashEnabled))
    for (let t of d.polygons) {
      let n = !0;
  ...
  for (let t of d.edges) {
    let n = $n(t.phase) * (0.55 + 0.45 * t.env);
    n <= 0.01 ||
      ((e.starSum[t.a] += n),
      (e.starSum[t.b] += n),
      n > e.starPeak[t.a] && (e.starPeak[t.a] = n),
      n > e.starPeak[t.b] && (e.starPeak[t.b] = n));
  }
  (lr(e, o), or(e, t, a), ur(e));
  let h = 0;
  for (let t of d.edges) {
    if (h >= e.caps.maxLinks) break;
    let n = $n(t.phase) * (0.62 + 0.38 * t.env);
    if (n < 0.008) continue;
    let r = (a - t.flashStart) / Fn,
      i = r >= 0 && r < 1 ? (r < 0.16 ? Qn(r / 0.16) : 1 - $n((r - 0.16) / 0.84)) : 0,
      o = h * 4,
      s = h * 2;
    ((e.segData[o] = e.starsX[t.a]),
      (e.segData[o + 1] = e.starsY[t.a]),
      (e.segData[o + 2] = e.starsX[t.b]),
      (e.segData[o + 3] = e.starsY[t.b]),
      (e.fxData[s] = n),
      (e.fxData[s + 1] = i),
      h++);
  }
...
function pr(e, t, n) {
  let r = P(e, B, fr(n.maxStars, n.maxLinks, n.maxPulses)),
    i = Zn(n),
    a = Rt(e, i.starBytes, n.maxStars, 1),
    o = Rt(e, i.starFxBytes, n.maxStars, 1),
    s = e.getUniformLocation(r, "uField"),
    c = e.getUniformLocation(r, "uStars"),
    l = e.getUniformLocation(r, "uStarFx"),
    u = e.getUniformLocation(r, "uCssSize"),
    d = e.getUniformLocation(r, "uCursor"),
    f = e.getUniformLocation(r, "uCursorFade"),
    p = e.getUniformLocation(r, "uLinkRadius"),
    m = e.getUniformLocation(r, "uTime"),
    h = e.getUniformLocation(r, "uStarCount"),
    g = e.getUniformLocation(r, "uLineCount"),
    _ = e.getUniformLocation(r, "uPulseCount"),
    v = e.getUniformLocation(r, "uLineStyle"),
    y = e.getUniformLocation(r, "uStarStyle"),
    b = e.getUniformLocation(r, "uStarExtra"),
    x = e.getUniformLocation(r, "uPulseStyle"),
    S = e.getUniformLocation(r, "uFlashStrength"),
    C = e.getUniformLocation(r, "uLineSeg"),
    w = e.getUniformLocation(r, "uLineFx"),
    T = e.getUniformLocation(r, "uPulseSeg"),
    E = e.getUniformLocation(r, "uPulseFx");
  return {
    render(D, O, k) {
      let A = k.config;
      (dr(i, A, k.cursor, k.cssW, k.cssH, k.now),
        (i.starsDirty &&= (zt(e, a, i.starBytes, n.maxStars, 1), !1)),
        zt(e, o, i.starFxBytes, n.maxStars, 1),
        z(e, D),
        e.useProgram(r),
        e.activeTexture(e.TEXTURE0),
        e.bindTexture(e.TEXTURE_2D, O),
        ...
        e.bindTexture(e.TEXTURE_2D, o),
        e.uniform1i(l, 2),
        e.uniform2f(u, k.cssW, k.cssH),
        e.uniform2f(d, i.hasSmooth ? i.smoothX : -1e5, i.hasSmooth ? i.smoothY : -1e5),
        e.uniform1f(f, i.cursorFade),
        e.uniform1f(p, Math.max(1, i.linkRadius)),
        e.uniform1f(m, k.timeSec),
        e.uniform1i(h, i.starCount),
        e.uniform1i(g, i.lineCount),
        e.uniform1i(_, i.pulseCount),
        e.uniform4f(v, A.linkThicknessPx, A.linkBrightness, A.linkGrooveDepth, A.linkShearPx),
        e.uniform4f(y, A.starSizePx, A.starSizeRandomness, A.starPushPx, A.starGrowScale),
        e.uniform3f(b, A.twinkleAmount, A.twinkleSpeed, A.flareScale),
        e.uniform3f(x, A.pulseCoreLenPx, A.pulseTailLenPx, A.pulseBrightness),
        e.uniform1f(S, A.polygonFlashEnabled ? A.polygonFlashStrength : 0),
        e.uniform4fv(C, i.segData),
        e.uniform2fv(w, i.fxData),
        e.uniform4fv(T, i.pulseSegData),
        e.uniform2fv(E, i.pulseFxData),
        t.draw());
    },
    dispose() {
...
function Zr(e, t, n, r, i, a) {
  let { px: o, py: s, vx: c, vy: l } = e,
    u = e.caps.nodeCount;
  ((c[0] += (t.headStiffness * (r - o[0]) - t.headDamping * c[0]) * n),
    (l[0] += (t.headStiffness * (i - s[0]) - t.headDamping * l[0]) * n),
    (o[0] += c[0] * n),
    (s[0] += l[0] * n));
  for (let e = 1; e < u; e++) {
    ((c[e] += (t.chainStiffness * (o[e - 1] - o[e]) - t.chainDamping * c[e]) * n),
      (l[e] += (t.chainStiffness * (s[e - 1] - s[e]) - t.chainDamping * l[e]) * n),
      (o[e] += c[e] * n),
      (s[e] += l[e] * n));
    let r = o[e] - o[e - 1],
      i = s[e] - s[e - 1],
...
function Qr(e, t, n) {
  let { px: r, py: i, nodeData: a, radiusData: o } = e,
    s = e.caps.nodeCount,
    c = s - 1;
  ...
  for (let e = 0; e < s; e++) {
    let a = e === 0 ? 0 : e - 1,
      s = e === c ? c : e + 1,
      l = Math.hypot(r[s] - r[a], i[s] - i[a]) / (s - a || 1),
      u = c > 0 ? e / c : 0,
      d = (t.headRadiusPx + (t.tailRadiusPx - t.headRadiusPx) * u) * n,
      f = br - (t.stretchThinning * l) / (Cr * n);
...
function $r(e, t, n, r, i, a, o, s, c) {
  ...
  e.emberCount += 1;
  let d = l(),
    f = (c > Br ? Math.atan2(-s, -o) : l() * Hr) + (l() - 0.5) * 2 * t.emberSpreadRad,
    p = t.emberSpeedMinPxPerSec + l() * (t.emberSpeedMaxPxPerSec - t.emberSpeedMinPxPerSec);
  e.lifePhase = (e.lifePhase + Vr) % 1;
  let m = (e.lifePhase + l() * zr) % 1;
  ((e.emberState[u] = n + (i - n) * d + (l() - 0.5) * Rr),
    (e.emberState[u + 1] = r + (a - r) * d + (l() - 0.5) * Rr),
    (e.emberState[u + 2] = Math.cos(f) * p),
    (e.emberState[u + 3] = Math.sin(f) * p),
    (e.emberState[u + 4] = 0),
    (e.emberState[u + 5] = t.emberLifetimeMinMs + m * (t.emberLifetimeMaxMs - t.emberLifetimeMinMs)),
    (e.emberState[u + 6] = t.emberSizePx * (1 + l() * Lr)));
}
function ei(e, t, n, r, i, a, o, s, c, l) {
  ...
  for (e.emitAccum += (Fr + (1 - Fr) * u) * t.emberRatePerSec * l; e.emitAccum >= 1; )
    (--e.emitAccum, $r(e, t, n, r, i, a, o, s, c));
}
function ti(e, t) {
  let n = t / 1e3,
    r = e.emberState,
...
function ni(e) {
  ...
  for (let n = 0; n < e.emberCount; n++) {
    let r = n * Mr,
      i = n * 4;
    ((e.emberData[i] = t[r]),
      (e.emberData[i + 1] = t[r + 1]),
      (e.emberData[i + 2] = t[r + 6]),
      (e.emberData[i + 3] = t[r + 4] / t[r + 5]));
  }
}
function ri(e, t, n, r, i, a) {
  let o = e.lastNow < 0 ? Gr : a - e.lastNow,
    s = o < Wr ? Wr : o > Ur ? Ur : o;
  e.lastNow = a;
  let c = s / 1e3,
    l = qr(r, i),
  ...
  let _ = Math.hypot(e.velX, e.velY),
    v = Yr((_ - Tr) / Er),
    y = u ? v ** +Dr : 0,
    b = y > e.presence ? t.presenceRiseRate : t.presenceFallRate;
  e.presence += (y - e.presence) * (1 - Math.exp(-c * b));
  let x = Yr((_ - Or) / kr),
    S = u ? x ** +Dr : 0,
    C = S > e.core ? t.presenceRiseRate * Ar : t.presenceFallRate * jr;
  ((e.core += (S - e.core) * (1 - Math.exp(-c * C))),
    u && e.wasActive && t.embersEnabled && ei(e, t, d, f, e.x, e.y, p, m, h, c),
    (e.wasActive = u),
    ti(e, s),
    ni(e));
  let w = Math.min(vr, Math.max(1, Math.ceil(c / _r))),
    T = c / w,
    E = t.maxLinkPx * l;
...
function si(e, t, n) {
  let r = P(e, B, ii(n.nodeCount)),
    i = P(e, oi, ai),
    a = e.createVertexArray(),
    o = e.createBuffer();
  if (!a || !o)
    throw (
      e.deleteProgram(r),
      e.deleteProgram(i),
      a && e.deleteVertexArray(a),
      o && e.deleteBuffer(o),
      Error("Failed to create comet trail GL objects")
    );
  (e.bindVertexArray(a), e.bindBuffer(e.ARRAY_BUFFER, o));
  let s = e.getAttribLocation(i, "aEmber");
  (e.enableVertexAttribArray(s),
    e.vertexAttribPointer(s, 4, e.FLOAT, !1, 16, 0),
    e.vertexAttribDivisor(s, 1),
    e.bindVertexArray(null),
    e.bindBuffer(e.ARRAY_BUFFER, null));
  let c = e.getUniformLocation(r, "uField"),
    l = e.getUniformLocation(r, "uHeat"),
    u = e.getUniformLocation(r, "uCssSize"),
    d = e.getUniformLocation(r, "uNode[0]"),
    f = e.getUniformLocation(r, "uNodeR[0]"),
    p = e.getUniformLocation(r, "uPresence"),
    m = e.getUniformLocation(r, "uCore"),
    h = e.getUniformLocation(r, "uTime"),
    g = e.getUniformLocation(r, "uSmoothUnionPx"),
    _ = e.getUniformLocation(r, "uStyle"),
    v = e.getUniformLocation(i, "uCanvas"),
    y = e.getUniformLocation(i, "uFadeIn"),
    b = null,
    x = -1,
    S = null;
  return {
    render(s, C, w) {
      let T = w.config;
      ((!b || T.seed !== x) && ((x = T.seed), (b = Jr(n, x))),
        ri(b, T, w.cursor, w.cssW, w.cssH, w.now),
        S ? _e(e, S, s.width, s.height) : (S = R(e, s.width, s.height, { linear: !0 })),
        z(e, S),
        e.clearColor(0, 0, 0, 1),
        e.clear(e.COLOR_BUFFER_BIT),
        T.embersEnabled &&
          b.emberCount > 0 &&
          (e.useProgram(i),
          e.uniform2f(v, Math.max(1, w.cssW), Math.max(1, w.cssH)),
          e.uniform1f(y, T.emberFadeInFraction),
          e.bindVertexArray(a),
          e.bindBuffer(e.ARRAY_BUFFER, o),
          e.bufferData(e.ARRAY_BUFFER, b.emberData.subarray(0, b.emberCount * 4), e.DYNAMIC_DRAW),
          e.bindBuffer(e.ARRAY_BUFFER, null),
          e.enable(e.BLEND),
          e.blendFunc(e.ONE, e.ONE),
          e.drawArraysInstanced(e.TRIANGLES, 0, 6, b.emberCount),
          e.disable(e.BLEND),
          e.bindVertexArray(null)),
        z(e, s),
        e.useProgram(r),
        ...
        e.uniform1i(l, 1),
        e.activeTexture(e.TEXTURE0),
        e.uniform2f(u, Math.max(1, w.cssW), Math.max(1, w.cssH)),
        e.uniform2fv(d, b.nodeData),
        e.uniform1fv(f, b.radiusData),
        e.uniform1f(p, b.presence),
        e.uniform1f(m, b.core),
        e.uniform1f(h, w.timeSec),
        e.uniform1f(g, T.smoothUnionPx),
        e.uniform4f(_, T.bodyBrightness, T.auraStrength, T.bodyPushPx, T.emberBrightness),
        t.draw());
    },
    dispose() {
      (e.deleteProgram(r),
        e.deleteProgram(i),
        e.deleteVertexArray(a),
        e.deleteBuffer(o),
        (S &&= (ve(e, S), null)),
        (b = null));
    },
...
function vi(e, t) {
  let n = 1 / Math.max(0.02, t),
    r = Math.min(0.999999, Math.max(1e-6, e.random())),
    i = -Math.log(1 - r) * n,
    a = n * li,
    o = n * ui;
...
function bi(e, t, n, r, i) {
  ...
  let o = (t.radiantAngleDeg * Math.PI) / 180,
    s = Math.cos(o),
    c = Math.sin(o),
    l = Math.abs(s) * Math.max(1, r),
    u = Math.abs(c) * Math.max(1, n),
    d = a() * (l + u) < u,
    f,
    p;
  d
    ? ((p = c > 0 ? -(pi + a() * 0.32) : 1.08 + a() * 0.32), (f = (s > 0 ? -0.45 : -0.05) + a() * 1.5))
    : ((f = s > 0 ? -(pi + a() * 0.34) : 1.08 + a() * 0.34), (p = (c > 0 ? -0.05 : 0.3) + a() * 0.75));
...
function xi(e, t, n, r, i) {
  ...
  ((e.hasArrival ||= ((e.nextArrivalSec = i + vi(e, t.ratePerSec) * 0.35), !0)),
    i - e.nextArrivalSec > di && (e.nextArrivalSec = i));
  let a = 0;
  for (; i >= e.nextArrivalSec && a < fi; )
    (bi(e, t, n, r, e.nextArrivalSec), (e.nextArrivalSec += vi(e, t.ratePerSec)), a++);
  let o = t.fadeInMs / 1e3,
    s = t.fadeOutMs / 1e3;
  ...
  for (let t of e.meteors) {
    ...
    let n = i - t.bornAtSec,
      r = yi(n, t.lifetimeSec, o, s);
    if (r <= 0) continue;
    let a = c * 4;
    ((e.originData[a] = t.spawnX),
      (e.originData[a + 1] = t.spawnY),
      (e.originData[a + 2] = n),
      (e.originData[a + 3] = r),
      (e.shapeData[a] = t.angleOffset),
      (e.shapeData[a + 1] = t.speedMul),
      (e.shapeData[a + 2] = t.lengthMul),
      (e.shapeData[a + 3] = t.thicknessMul),
      c++);
  }
  e.count = c;
}
...
function Ci(e, t, n) {
  let r = P(e, B, Si(n.maxActive)),
    i = null,
    a = -1,
    o = e.getUniformLocation(r, "uField"),
    s = e.getUniformLocation(r, "uCssSize"),
    c = e.getUniformLocation(r, "uRadiant"),
    l = e.getUniformLocation(r, "uStyle"),
    u = e.getUniformLocation(r, "uMeteorCount"),
    d = e.getUniformLocation(r, "uMeteorOrigin[0]"),
    f = e.getUniformLocation(r, "uMeteorShape[0]");
  return {
    render(p, m, h) {
      let g = h.config;
      ...
      (z(e, p),
        ...
        e.uniform1i(o, 0),
        e.uniform2f(s, Math.max(1, h.cssW), Math.max(1, h.cssH)),
        e.uniform2f(c, Math.cos(_), Math.sin(_)),
        e.uniform4f(l, g.brightness, g.headGlow, g.pushPx, g.pushFalloffScale),
        e.uniform1i(u, i.count),
        e.uniform4fv(d, i.originData),
        e.uniform4fv(f, i.shapeData),
        t.draw());
    },
    dispose() {
      e.deleteProgram(r);
...
function ki(e) {
  let t = (e.debrisLifetimeMs / 1e3) * (1 + e.debrisLifetimeVariation),
    n = e.ringDurationMs / 1e3,
    r = e.craterLifeMs / 1e3;
  return Math.max(t, n, r);
}
function Ai(e) {
  return 3 * e * (1 - e) * (1 - e) * 0.6 + e * e * e;
}
function ji(e) {
  return 3 * e * (1 - e) * (1 - e) * 0.6 + 3 * e * e * (1 - e) + e * e * e;
}
function Mi(e) {
  if (e <= 0) return 0;
  if (e >= 1) return 1;
  let t = 0,
    n = 1,
    r = e;
  for (let i = 0; i < Ei; i++) ((r = (t + n) * 0.5), Ai(r) < e ? (t = r) : (n = r));
  return ji(r);
}
function Ni(e, t, n, r, i) {
  let a = Math.max(1, Math.min(e.caps.maxConcurrent, Math.round(t.maxConcurrent)));
  (e.detonations.length >= a && e.detonations.splice(0, e.detonations.length - a + 1),
    e.detonations.push({
      x: n,
      y: r,
      seed: 1 + e.random() * Ti,
...
function Pi(e, t, n) {
  ...
  for (let t of e.detonations) {
    ...
    let o = a * 4;
    ((e.lifeData[o] = r),
      (e.lifeData[o + 1] = t.seed),
      (e.lifeData[o + 2] = Mi(i > 0 ? Math.min(1, r / i) : 1)),
      (e.lifeData[o + 3] = 1),
      a++);
  }
  e.count = a;
...
function Ii(e, t, n) {
  let r = P(e, B, Fi(n.maxConcurrent, n.debrisCount)),
    i = e.getUniformLocation(r, "uField"),
    a = e.getUniformLocation(r, "uCssSize"),
    o = e.getUniformLocation(r, "uDetCount"),
    s = e.getUniformLocation(r, "uDetCenter[0]"),
    c = e.getUniformLocation(r, "uDetLife[0]"),
    l = e.getUniformLocation(r, "uRing"),
    u = e.getUniformLocation(r, "uFlash"),
    d = e.getUniformLocation(r, "uDebrisA"),
    f = e.getUniformLocation(r, "uDebrisB"),
    p = e.getUniformLocation(r, "uCrater"),
    m = e.getUniformLocation(r, "uCraterExtra");
  return {
    render(n, h, g) {
      let _ = g.config,
        v = g.state;
      (Pi(v, _, g.timeSec),
        ...
        e.uniform1i(i, 0),
        e.uniform2f(a, Math.max(1, g.cssW), Math.max(1, g.cssH)),
        e.uniform1i(o, v.count),
        e.uniform2fv(s, v.centerData),
        e.uniform4fv(c, v.lifeData),
        e.uniform4f(l, _.ringReachPx, _.ringDurationMs / 1e3, _.ringThicknessPx, _.ringRefractionPx),
        e.uniform4f(u, _.flashRadiusPx, _.flashBrightness, _.flashDurationMs / 1e3, 0),
        e.uniform4f(d, _.debrisSpeedPxPerSec, _.debrisSpeedVariation, _.debrisDrag, _.debrisGravityPxPerSec2),
        e.uniform4f(f, _.debrisLifetimeMs / 1e3, _.debrisLifetimeVariation, _.debrisSizePx, _.debrisBrightness),
        e.uniform4f(p, _.craterRadiusPx, _.craterDepth, _.craterRelaxFastMs / 1e3, _.craterRelaxSlowMs / 1e3),
        e.uniform4f(m, _.craterLifeMs / 1e3, _.craterRimStrength, 0, 0),
        t.draw());
    },
    dispose() {
      e.deleteProgram(r);
...
function zi(e, t) {
  let n = Math.hypot(e.vx, e.vy),
    r = n > 0 ? (-e.vx / n) * t.pushLagPx : 0,
    i = n > 0 ? (-e.vy / n) * t.pushLagPx : 0,
    a = Math.cos(e.seed * 1.37 + e.ageMs * 0.01) * t.pushWobblePx,
    o = Math.sin(e.seed * 1.91 + e.ageMs * 0.012) * t.pushWobblePx;
  return {
    x: e.x + r + a,
    y: e.y + i + o,
  };
...
function Bi(e, t, n, r, i) {
  let a = e.nextSeed++,
    o = Ri(a, 1) * Math.PI * 2,
    s = i.spreadMinPx + Ri(a, 2) * (i.spreadMaxPx - i.spreadMinPx),
    c =
      r > 0
        ? {
            x: -n.y / r,
  ...
  return {
    ...
    radius: i.particleRadius * (0.75 + Ri(a, 5) * 0.8),
...
function Ui(e, t, n = b) {
  let r = T(n),
    i = Math.max(0, Math.min(48, t || 16.67)),
    a = e.drops.length > 0,
    o = i / Li;
  if (!r.enabled) {
  ...
  if (e.target) {
    ...
    let a = Math.hypot(e.velocity.x, e.velocity.y),
      s = e.lastEmit ?? e.current,
      c = Math.hypot(e.current.x - s.x, e.current.y - s.y) / r.particleSpacingPx + o + e.emitRemainder,
      l = Math.min(Math.max(1, Math.round(r.maxEmitPerTick * o)), Math.floor(c));
    e.emitRemainder = c % 1;
    for (let t = 0; t < l; t++) {
      let n = l <= 1 ? 1 : t / (l - 1),
        i = {
  ...
  for (let t of e.drops) {
    ...
    let n = 1 - e / t.lifeMs,
      a = Math.sin(t.x * 0.017 + t.y * 0.013 + t.seed) * t.spin * o,
      u = (t.vx - t.vy * a) * s,
      d = (t.vy + t.vx * a) * s,
      f = {
        ...t,
...
function Qi(e, t, n = o) {
  let r = E(n),
    i = Math.max(0, Math.min(Gi, t || 16.67)),
    a = e.waves.length > 0;
  if (!r.enabled) {
  ...
  for (let t of e.waves) {
    ...
    let n = e / t.lifeMs,
      a = qi(n),
      o = r.startRadiusPx + (r.maxRadiusPx - r.startRadiusPx) * a,
      l = r.startStrokeWidthPx + (r.endStrokeWidthPx - r.startStrokeWidthPx) * n,
      u = 1 - n;
    (c.push({
      ...t,
      ageMs: e,
  ...
  return {
    render(r, a, o) {
      (z(e, r),
        ...
        e.uniform1i(i.prev, 0),
        e.uniform2f(i.texel, o.texelX, o.texelY),
        e.uniform2f(i.splatA, o.ax, o.ay),
        e.uniform2f(i.splatB, o.bx, o.by),
        e.uniform1f(i.amp, o.amp),
        e.uniform1f(i.radius, o.radius),
        t.draw(),
        e.bindFramebuffer(e.FRAMEBUFFER, null));
    },
    dispose() {
...
function ya(e, t) {
  ...
  function p(t, r, u, d) {
    ...
    let y = Math.max(1, Math.round(u / fa)),
      b = Math.max(1, Math.round(d / fa)),
      x = Math.max(y, b);
    if (x > pa) {
      let e = pa / x;
    ...
    try {
      ...
      let t = _ === 0 ? 0 : (p / Math.max(1, u)) * y,
        r = _ === 0 ? 0 : ((d - m) / Math.max(1, d)) * b,
        c = _ === 0 ? 0 : (h / Math.max(1, u)) * y,
        l = _ === 0 ? 0 : ((d - g) / Math.max(1, d)) * b;
      for (let e = 0; e < v; e++) {
        let a = e / v,
          o = (e + 1) / v;
  ...
  return {
    tick(e, t, n, i) {
      ...
      d = e;
      let o = r.advance(e, a, t),
        s = o.amp === 0 ? 0 : Math.min(1, Math.abs(o.amp) * 3.2);
...
function Ma(e, t) {
  ...
  let n = ka((t - e.shownAtMs) / Ta),
    r = ka((e.phaseEndMs - t) / wa);
  return Math.min(n, r);
}
function Na(e, t, n) {
  let r = Math.sin(t * e.turnFreq1 + e.turnPhase1) + 0.6 * Math.sin(t * e.turnFreq2 + e.turnPhase2);
...
function Pa(e, t, n, r) {
  ...
  if (i >= r) return 0;
  let a = Math.min(1, (r - i) / r),
    o = Math.atan2(n * 0.5 - e.y, t * 0.5 - e.x),
    s = Math.atan2(Math.sin(o - e.heading), Math.cos(o - e.heading));
  return a * a * Ea * s;
}
function Fa(e, t, n, r, i) {
  let a = t.vortexSingular,
    o = t.baseSpeedPxPerSec * 0.5 * t.speedVariation,
    s = J(Math.max(1, t.baseSpeedPxPerSec - o), t.baseSpeedPxPerSec + o, e()),
    c = J(a.lifeMinMs, a.lifeMaxMs, e()),
    l = ja(s, a),
    u = J(a.visibleMinMs, a.visibleMaxMs, e()),
    d = e() * n.width,
    f = e() * n.height;
  return {
    x: d,
    ...
    turnDir: e() < 0.5 ? -1 : 1,
    turnFreq1: J(0.15, 0.4, e()),
    turnFreq2: J(0.15, 0.4, e()) * Oa,
    turnPhase1: e() * Math.PI * 2,
    turnPhase2: e() * Math.PI * 2,
    bornMs: i ? r - e() * c * 0.8 : r,
    lifeMs: c,
...
function Ia(e, t) {
  let n = t.segCount * t.segSpacingPx * 1.25 + 40,
    r = e.trailX,
    i = e.trailY,
    a = 0;
  for (let e = r.length - 1; e > 0; e--)
    if (((a += Math.hypot(r[e] - r[e - 1], i[e] - i[e - 1])), a > n)) {
...
function La(e, t, n, r) {
  ...
  for (let l = i.length - 1; l > 0 && s < n.segCount; l--) {
    let u = i[l],
      ...
      f = i[l - 1],
      p = a[l - 1],
      m = Math.hypot(f - u, p - d);
    if (m <= 0) continue;
    let h = Math.atan2(d - p, u - f);
    for (; s < n.segCount && s * n.segSpacingPx <= c + m; ) {
      let i = (s * n.segSpacingPx - c) / m,
        a = 1 - s / n.segCount,
        l = Math.max(1, t.thickness * (xa + (1 - xa) * a));
      (e.push({
        x: J(u, f, i) - o * 0.5,
        y: J(d, p, i) - l * 0.5,
        width: o,
...
function za(e, t, n, r) {
  ...
  let a = Math.min(0.1, Math.max(0, (r - e.lastStepMs) / 1e3));
  ...
  for (let s = 0; s < e.tails.length; s++) {
    let c = e.tails[s];
    (r - c.bornMs >= c.lifeMs && ((c = Fa(e.random, t, n, r, !1)), (e.tails[s] = c)),
      !c.hidden && r >= c.phaseEndMs
        ? ((c.hidden = !0), (c.phaseEndMs = r + J(i.hiddenMinMs, i.hiddenMaxMs, e.random())))
        : c.hidden &&
          r >= c.phaseEndMs &&
          ((c.hidden = !1),
          (c.shownAtMs = r),
          (c.phaseEndMs = r + ja(c.speedPxPerSec, i) + J(i.visibleMinMs, i.visibleMaxMs, e.random())),
          (c.trailX = [c.x]),
          (c.trailY = [c.y])));
    let l = (r - c.bornMs) / 1e3,
      u = Na(c, l, i) + Pa(c, n.width, n.height, o);
    ((c.heading += u * a),
      (c.x += Math.cos(c.heading) * c.speedPxPerSec * a),
      (c.y += Math.sin(c.heading) * c.speedPxPerSec * a));
...
function qa(e) {
  let t = 0.4 + -0.34 * Math.min(1, Math.max(0, e));
  return {
    inner: 0.5 - t,
    outer: 0.5 + t,
  };
...
function Ja(e) {
  let t = e.baseSpeedPxPerSec * 0.5 * e.speedVariation;
  return {
...
function Ya(e, t, n, r) {
  ...
  return (
    (i = Math.imul(i ^ Math.round(t * 1013), 3266489909)),
    (i = Math.imul(i ^ Math.round(n * 131), 668265263)),
    (i = Math.imul(i ^ Math.round(r * 100003), 374761393)),
    (i ^= i >>> 15),
    (i >>> 0) / 4294967296
  );
}
function Xa(e, t, n, r, i) {
  let a = Ha(e.random, n, t.minWidthRatio, t.maxWidthRatio),
    o = Ha(e.random, r, t.minHeightRatio, t.maxHeightRatio),
    s = Ja(t),
    c = Va(e.random, s.minPxPerSec, s.maxPxPerSec),
    l = Va(e.random, t.opacityMin, t.opacityMax),
    u = {
      width: a,
      height: o,
      speedPxPerSec: c,
...
function eo(e, t, n, r) {
  if (!(!t.enabled || e.flames.length > 0 || n <= 0 || r <= 0))
    for (let i = 0; i < t.maxActive; i++) {
      let i = Xa(e, t, n, r, Ka(e, t.direction));
...
function no(e, t, n, r) {
  ...
  !(e.flames.length >= t.maxActive) &&
    r - e.lastSpawnMs >= a &&
    (e.flames.push($a(e, t, n.width, n.height)), (e.lastSpawnMs = r));
}
//#endregion
  ...
  return {
    ...
    poll() {
      ...
      for (let n = r.length - 1; n >= 0; n--) {
        let a = r[n],
          o = e.getQueryParameter(a.query, e.QUERY_RESULT_AVAILABLE);
        if (o || t) {
          if (o && !t) {
...
function mo(e, t, n, r, i, a, o, s) {
  ...
  (i === "width"
    ...
    : i === "height"
      ? (c = d / u)
      : i !== "stretch" && (i === "cover" ? (u > d ? (c = d / u) : (l = u / d)) : u > d ? (l = u / d) : (c = d / u)),
    (c /= a),
    (l /= a));
  let f = 0.5 + o * c * 0.5,
    p = 0.5 + s * l * 0.5;
...
function _o(e) {
  ...
  for (let e = 0; e < 256; e++) {
    ...
    ((t[i] = (a.color >> 16) & 255),
      (t[i + 1] = (a.color >> 8) & 255),
      (t[i + 2] = a.color & 255),
      (t[i + 3] = Math.max(0, Math.min(255, Math.round(a.width * 2)))));
  }
  return t;
}
function vo(e, t) {
  let n = [...e].sort((e, t) => e.startFrom - t.startFrom),
    r = Number.isFinite(t) ? Math.max(0, Math.min(1, t)) : 0,
    i = n
      .map((e, t) => ({
        band: t,
        stripe: e,
      }))
      .filter(({ stripe: e }) => e.width >= 2 && e.opacity > 0.001)
      .sort((e, t) => t.stripe.startFrom - e.stripe.startFrom || t.band - e.band),
    a = r <= 0 ? 0 : Math.ceil(i.length * r),
    o = new Set(i.slice(0, a).map(({ band: e }) => e));
  return n.map((e, t) => o.has(t));
}
function yo(e, t = 1) {
  let n = new Uint8Array(256 * 4);
  if (e.length === 0) return n;
  let r = [...e].sort((e, t) => e.startFrom - t.startFrom),
    i = vo(r, t);
  for (let e = 0; e < 256; e++) {
    let t = go(r, e / 255),
      a = e * 4,
      o = t < 0 ? 0 : Math.max(0, Math.min(255, Math.round(r[t].opacity * 255))),
      s = t < 0 ? 0 : r.length <= 1 ? 1 : t / (r.length - 1);
    ((n[a] = o),
      (n[a + 1] = Math.max(0, Math.min(255, Math.round(s * 255)))),
      (n[a + 2] = t >= 0 && i[t] ? 255 : 0),
      (n[a + 3] = 255));
  }
  return n;
...
function Co(e, t, n) {
  ...
  return (a.length > 0 ? a : e.slice(-1)).map((e) => {
    let t = So(0.45, 1, e.startFrom),
      n = Math.max(r, e.startFrom - t * i * 0.12),
      a = Math.round(e.width * (1 + t * i));
    return {
      ...e,
      startFrom: n,
...
function wo(e) {
  return e.colors.mode === "colors"
    ? Co(e.stripes, e.colors.imageColorRemoveThin, e.colors.imageColorBoostThick)
    : e.stripes;
}
//#endregion
...
function Eo(e, t, n) {
  ...
  let r = /* @__PURE__ */ new Map(),
    ...
    s = (n, s) => {
      let c = (s * t + n) * 4,
        ...
        f = (l << 16) | (u << 8) | d;
      (r.set(f, (r.get(f) ?? 0) + 1),
        i.set(f, (i.get(f) ?? 0) + e[c]),
        a.set(f, (a.get(f) ?? 0) + e[c + 1]),
        o.set(f, (o.get(f) ?? 0) + e[c + 2]));
    };
  ...
  if (l === 0) return 0;
  let u = l,
    d = Math.round((i.get(c) ?? 0) / u),
    f = Math.round((a.get(c) ?? 0) / u),
    p = Math.round((o.get(c) ?? 0) / u);
...
function Fo(e = 8) {
  let t = [];
  for (let n = 0; n < e; n++) t.push(Po((360 / e) * n, 0.85, 0.55));
  return t;
}
function Io(e, t, n, r = {}) {
  if (t <= 0 || n <= 0 || e.length < t * n * 4) return Fo();
  let i = r.maxColors ?? Do,
    a = Math.max(1, r.stride ?? Oo),
    o = r.dedupeDistance ?? ko,
    s = [];
  for (let r = 0; r < n; r += a)
    for (let n = 0; n < t; n += a) {
      let i = (r * t + n) * 4,
...
function Ro(e, t) {
  ...
  return {
    render(r, a, o) {
      ...
      let s = o.adjustments;
      (e.uniform3f(i.bg, ...V(o.background)),
        e.uniform3f(i.colorBg, ...V(o.colorBackground)),
        e.uniform1f(i.blur, s.blurRadius),
        e.uniform1f(i.sharpen, s.sharpenAmount),
        e.uniform1f(i.black, s.blackPoint),
        e.uniform1f(i.white, s.whitePoint),
...
function Bo(e, t) {
  let n = P(e, B, zo),
    r = e.getUniformLocation(n, "uTex"),
    i = e.getUniformLocation(n, "uSrcSize");
  return {
    render(a, o, s, c) {
      (z(e, a),
        e.useProgram(n),
...
function Vo(e) {
  ...
  return [t === "left" ? 0 : t === "right" ? 1 : 0.5, n === "top" ? 0 : n === "bottom" ? 1 : 0.5];
}
function X(e) {
...
function Ho(e) {
  return Math.min(0.4, Math.max(0.04, 330 / e));
}
function Uo(e, t, n) {
  let r = Math.max(1, Math.round(t)),
    ...
    o = Math.min(a, 1 - a),
    s = i * r,
    c = Math.min(r - 1, Math.floor(s)),
    l = s - c,
    u = l * l * (3 - 2 * l),
    d = c % 2 == 0 ? u * 2 - 1 : 1 - u * 2,
    f = Math.sin(i * Math.PI * 2 * r * 1.5) * n * 0.05,
    p = d * o + f;
  return {
...
function es(e, t) {
  ...
  function v(n, i) {
    if (!o || !s) return;
    let c = 0.8 - 0.45 * Math.min(1, Math.max(0, n));
    (z(e, s.write()),
      e.useProgram(r),
      e.activeTexture(e.TEXTURE0),
      e.bindTexture(e.TEXTURE_2D, s.read().texture),
      e.uniform1i(a.prevCover, 0),
      e.activeTexture(e.TEXTURE1),
      e.bindTexture(e.TEXTURE_2D, o.read().texture),
      e.uniform1i(a.height, 1),
      e.uniform1f(a.revealK, Qo),
      e.uniform1f(a.gamma, c),
      e.uniform1f(a.soak, $o * i),
      t.draw(),
      e.bindFramebuffer(e.FRAMEBUFFER, null),
      s.swap());
  }
  return {
    tick(t) {
      ...
      let r = Math.max(1, Math.round(t.displayWidth / Jo)),
        i = Math.max(1, Math.round(t.displayHeight / Jo)),
        a = Math.max(r, i);
      if (a > Yo) {
        let e = Yo / a;
      ...
      try {
        ...
        let a = f.advance(t.elapsedMs, t.sweepT, t.rows, t.wobble, t.intensity),
          u = a.ax * r,
          p = a.ay * i,
          m = a.bx * r,
          g = a.by * i,
          y = a.amp * Xo,
          b = Math.max(3, i / (Math.max(1, t.rows) * 2.6));
...
function cs(t, n) {
  let r = n.clock ?? O(),
    ...
    o = n.cssWidth,
    s = n.cssHeight,
    { gl: c, isP3: l, maxTextureSize: d } = t.acquireContext(),
    f = {
      width: 0,
      height: 0,
    },
    ...
    oe = () =>
      E.reveal.enabled
        ? E.reveal.type === "wave"
          ? "wave"
          : E.reveal.type === "assembly"
            ? "scatter"
            : E.reveal.type === "vortex"
              ? "vortex"
              : E.reveal.type === "blackhole"
                ? "blackhole"
                : E.reveal.type === "whirlpool"
                  ? "whirlpool"
                  : E.reveal.type === "water"
                    ? "water"
                    : E.reveal.type === "custom"
                      ? i?.customReveal
                        ? "custom"
                        : "wave"
                      : "warp"
    ...
    le = oe(),
    I = E.flames.enabled,
    L = E.flames.direction,
    ue = $e(E) === "field",
    me = E.renderMode,
    ge = E.cursorTrail.enabled,
    R = E.clickWave.enabled,
    _e = E.clickWave.type,
    ve = E.letters.enabled,
    be = E.colors.mode,
    B = E.background.stars.enabled,
    xe = Wo(r);
  function V() {
    return xe.elapsedMs();
  }
  ...
  let Ce = E.colors.backgroundColor,
    H = null,
    U = null,
    Ee = Fo(),
    De = Math.sqrt(3),
    ...
    We = () => W.target,
    G = null,
    qe = E.cursorTrail.type,
    Ye = ea(n.onWaterActivity),
    Ze = () => E.cursorTrail.enabled && E.cursorTrail.type === "constellation",
    Qe = () => {
      if (!Ze()) return "off";
    ...
    et = Qe(),
    tt = () => E.cursorTrail.enabled && E.cursorTrail.type === "comet",
    it = () => {
      if (!tt()) return "off";
    ...
    K = it(),
    ot = () => (E.background.meteors.enabled ? String(mi(E.background.meteors).maxActive) : "off"),
    st = ot(),
    ct = () => E.clickWave.enabled && E.clickWave.type === "detonation",
    lt = () => {
      if (!ct()) return "off";
    ...
    pt = () => {
      let e = Di(E.clickWave.detonation),
        t = `${e.maxConcurrent}|${e.debrisCount}|${E.clickWave.detonation.seed}`;
  ...
  function yt(e, t) {
    ...
    let n = 1,
      r = 1;
    typeof HTMLVideoElement < "u" && e instanceof HTMLVideoElement
      ? ((n = e.videoWidth || 1), (r = e.videoHeight || 1))
      : typeof HTMLImageElement < "u" && e instanceof HTMLImageElement
        ? ((n = e.naturalWidth || e.width || 1), (r = e.naturalHeight || e.height || 1))
        : ((n = e.width || 1), (r = e.height || 1));
  ...
  function Dt() {
    ...
    let e = mo(
      ...
      t = x.get("colorDistFull", m.width, m.height);
    ...
    let n = m.width,
      ...
      o = 0;
    for (; n > 1 || r > 1; ) {
      let e = Math.max(1, Math.ceil(n / 4)),
        t = Math.max(1, Math.ceil(r / 4)),
        s = x.get(`colorMaxReduce${o}`, e, t);
      (Me.render(s, i, n, r), (i = s.texture), (a = s), (n = e), (r = t), o++);
    }
    let s = new Uint8Array(4);
    (c.bindFramebuffer(c.FRAMEBUFFER, a.fbo),
      c.readPixels(0, 0, 1, 1, c.RGBA, c.UNSIGNED_BYTE, s),
  ...
  function Ot() {
    let e = wo(E),
      t = `${bo(e)}|stripeDotsDensity:${E.stripeDots.density}`;
    if (t !== te) {
      let n = _o(e),
        r = yo(e, E.stripeDots.density);
  ...
  function jt() {
        ...
        (t = {
          ...
          render: () => {
            let t = x.get("field", p.width, p.height, { linear: !0 }),
              r = x.get("fieldColor", p.width, p.height, { linear: !0 });
            if (T) {
              T.update();
              let i = mo(
                T.width,
              ...
              (c.bindFramebuffer(c.FRAMEBUFFER, t.fbo),
                c.clearColor(0, 0, 0, 1),
                c.clear(c.COLOR_BUFFER_BIT),
                c.bindFramebuffer(c.FRAMEBUFFER, r.fbo),
    ...
    if (m && E.reveal.type === "vortex") {
      ...
      j.push({
        ...
        render: () => {
          let t = x.get("field", p.width, p.height, { linear: !0 }),
            n = x.get("revealedField", p.width, p.height, { linear: !0 }),
            r = E.reveal.vortex,
            i = X(E.reveal),
            a = V() / i,
            c = Math.max(1, r.staggerMs + r.speedMaxMs),
            l = Math.max(0, r.speedMinMs),
            u = Math.max(l, r.speedMaxMs),
            d = Math.min(0.98, Math.max(0.05, (l + u) / 2 / c)),
            f = r.staggerMs / c,
            m = Math.round(280 + 280 * r.detail),
            h = Math.max(2, Math.round((m * s) / Math.max(1, o)));
      ...
      j.push({
        ...
        render: () => {
          let t = x.get("field", p.width, p.height, { linear: !0 }),
            n = x.get("revealedField", p.width, p.height, { linear: !0 }),
            r = E.reveal.blackhole,
            i = X(E.reveal),
            a = Math.max(1, i),
            c = V() / a,
            l = Math.max(1, r.speedMinMs),
            u = Math.max(l, r.speedMaxMs),
            d = Math.round(280 + 280 * r.detail),
            f = Math.max(2, Math.round((d * s) / Math.max(1, o))),
            m = 4200;
          e.render(n, t.texture, {
            progress: c,
            form: r.formMs / a,
      ...
      j.push({
        ...
        render: () => {
          let t = x.get("field", p.width, p.height, { linear: !0 }),
            n = x.get("revealedField", p.width, p.height, { linear: !0 }),
            r = E.reveal.whirlpool,
            i = Math.max(1, X(E.reveal)),
            a = V() / i;
          e.render(n, t.texture, {
            progress: a,
            turns: r.turns,
      ...
      j.push({
        ...
        render: () => {
          ...
          let r = E.reveal.type,
            ...
            a = X(E.reveal),
            o = V() / a,
            s = Math.max(1, i.staggerMs + i.speedMaxMs),
            c = Math.max(0, i.speedMinMs),
            l = Math.max(c, i.speedMaxMs),
            u = Math.min(0.98, Math.max(0.05, (c + l) / 2 / s)),
            d = i.staggerMs / s;
          e.render(n, t.texture, {
            mode: is[r] ?? 0,
            progress: o,
      ...
      j.push({
        ...
        render: () => {
          let n = x.get("field", p.width, p.height, { linear: !0 }),
            r = x.get("revealedField", p.width, p.height, { linear: !0 }),
            i = E.reveal.assembly,
            a = i.blurPx ?? u.assembly.blurPx ?? 0,
            c = i.blurStart ?? u.assembly.blurStart ?? 0,
            l = X(E.reveal),
            d = V() / l,
            f = Math.max(0, Math.min(1, d)),
            m = Math.max(1, i.staggerMs + i.speedMaxMs),
            h = Math.max(0, i.speedMinMs),
            g = Math.max(h, i.speedMaxMs),
            _ = Math.min(0.98, Math.max(0.05, (h + g) / 2 / m)),
            v = i.staggerMs / m,
            y = Math.max(1, i.sliceSizePx),
            b = Math.max(1, Math.ceil(o / y)),
            S = Math.max(1, Math.ceil(s / y)),
            C = Math.min(1, v + _),
            w = n.texture,
            T = n.texture,
            D = n.texture;
          if (f < C && a > 0) {
            let e = {
              ...
              r = x.get("assemblyBlurQuarter", e.width, e.height, { linear: !0 }),
              i = x.get("assemblyBlurHalf", e.width, e.height, { linear: !0 }),
              s = x.get("assemblyBlurFull", e.width, e.height, { linear: !0 }),
              c = x.get("assemblyBlurTemp", e.width, e.height, { linear: !0 }),
              l = (a * e.width) / Math.max(1, o);
            (t.copy(n.texture, r),
              t.render(r.texture, c, r, (l * 0.25) / 0.45, e),
              t.render(r.texture, c, i, ((Math.sqrt(3) / 4) * l) / 0.45, e));
            let u = (l * (Math.sqrt(3) / 2 / Math.SQRT2)) / 0.45;
            (t.render(i.texture, c, s, u, e),
              t.render(s.texture, c, s, u, e),
              (w = r.texture),
              (T = i.texture),
              (D = s.texture));
          }
      ...
      ((ee = () => r),
        j.push({
          ...
          render: () => {
            let i = E.reveal.water,
              a = Math.max(1, i.durationMs),
              c = Math.max(0, i.settleMs),
              l = V(),
              u = Math.min(1, Math.max(0, l / a)),
              d = c <= 0 ? +(u >= 1) : Math.min(1, Math.max(0, (l - a) / c));
            if (u >= 1 && d >= 1) {
              ((n ||= (e.release(), !0)), (r = !1));
              return;
            }
            r = !0;
            let f = x.get("field", p.width, p.height, { linear: !0 }),
              m = x.get("revealedField", p.width, p.height, { linear: !0 }),
              h = 1 - d * d * (3 - 2 * d);
            ((n = !1),
              e.tick({
                elapsedMs: l,
        ...
        j.push({
          ...
          render: () => {
            let { cols: n, rows: r } = h,
              i = X(E.reveal),
              a = V() / i,
              o = Ho(E.reveal.wave.durationMs);
            if (a >= 1 + Math.max(0, E.reveal.wave.softness) + o + E.reveal.wave.waviness * 0.5 + 0.001) {
              t = !1;
              return;
            }
            t = !0;
            let s = x.get("field", p.width, p.height, { linear: !0 }),
              c = x.get("revealedField", p.width, p.height, { linear: !0 }),
              [l, u] = Vo(E.reveal.wave.position),
              d = Math.max(
                Math.hypot(l, u),
                Math.hypot(1 - l, u),
                Math.hypot(l, 1 - u),
    ...
    if (i?.fieldPass) {
      ...
      (te.push({
        name: "hookField",
        render: () => {
          let n = x.get(_(t), p.width, p.height, { linear: !0 }),
            i = x.get("hookField", p.width, p.height, { linear: !0 });
          e.render({
            input: n,
            output: i,
            fieldSize: p,
    ...
    if ($e(E) === "field") {
      ...
      (ne.push({
        name: "edgeMaskField",
        render: () => {
          let n = x.get(_(t), p.width, p.height, { linear: !0 }).texture,
            r = x.get("maskedField", p.width, p.height, { linear: !0 });
          e.render(r, n, {
    ...
    let ie = [],
      N = E.cursorTrail.enabled && E.cursorTrail.type === "default",
      P = E.clickWave.enabled && E.clickWave.type === "default";
    if (N || P) {
      let t = N,
        n = P,
        i = t ? Sn(c) : null,
        ...
        d = g.length,
        f = !1,
        m = () => !t && He.waves.length === 0 && He.clearFramesRemaining === 0;
      (ie.push({
        name: "cursorField",
        render: () => {
          let g = r.now() - Ue;
          ...
          let { cols: v, rows: y } = h,
            b = v / Math.max(1, o),
            S = t ? Math.min(ts, E.cursorTrail.pushStrengthPx * b) : 0,
            w = n ? Math.min(ns, E.clickWave.pushStrengthPx * b) : 0,
            T = Math.max(S, w),
            D = x.get("cursorAccum", v, y, { float: !0 });
          if ((z(c, D), c.clearColor(0, 0, 0, 0), c.clear(c.COLOR_BUFFER_BIT), i)) {
            let { samples: e } = Ui(W, g, E.cursorTrail),
              t = (E.cursorTrail.pushStrengthPx * v) / Math.max(1, o);
            i.render(D, e, {
              cols: v,
              rows: y,
              displayWidth: o,
          ...
          if (a) {
            let { samples: e } = Qi(He, g, E.clickWave),
              t = (E.clickWave.pushStrengthPx * v) / Math.max(1, o);
            a.render(D, e, {
              cols: v,
              rows: y,
              displayWidth: o,
          ...
          let k = {
            ...
            A = x.get(_(d), p.width, p.height, { linear: !0 }).texture,
            ee = x.get("cursorField", p.width, p.height, { linear: !0 });
          if ((u.render(ee, A, D.texture, O.texture, k), e)) {
            let e = x.get(C(d), p.width, p.height, { linear: !0 }).texture,
              t = x.get("cursorFieldColor", p.width, p.height, { linear: !0 }),
              n = Ee[0],
              r = n ? [n.r / 255, n.g / 255, n.b / 255] : [1, 0.5, 0.2];
    ...
    let ae = [];
    if (Ze()) {
      let e = pr(c, b, Xn(E.cursorTrail.constellation)),
        t = g.length;
      (ae.push({
        name: "constellationField",
        render: () => {
          let n = x.get(_(t), p.width, p.height, { linear: !0 }).texture,
            i = x.get("constellationField", p.width, p.height, { linear: !0 });
          e.render(i, n, {
    ...
    let oe = [];
    if (tt()) {
      let e = si(c, b, Kr(E.cursorTrail.comet)),
        t = g.length;
      (oe.push({
        name: "cometField",
        render: () => {
          let n = x.get(_(t), p.width, p.height, { linear: !0 }).texture,
            i = x.get("cometField", p.width, p.height, { linear: !0 });
          e.render(i, n, {
    ...
    if (E.background.meteors.enabled) {
      let e = Ci(c, b, mi(E.background.meteors)),
        t = g.length;
      (se.push({
        name: "meteorsField",
        render: () => {
          let n = x.get(_(t), p.width, p.height, { linear: !0 }).texture,
            i = x.get("meteorsField", p.width, p.height, { linear: !0 });
          e.render(i, n, {
    ...
    let ce = [];
    if (ct()) {
      let e = Ii(c, b, Di(E.clickWave.detonation)),
        t = g.length;
      (ce.push({
        name: "detonationField",
        render: () => {
          let n = x.get(_(t), p.width, p.height, { linear: !0 }).texture,
            i = x.get("detonationField", p.width, p.height, { linear: !0 });
          e.render(i, n, {
    ...
    if (E.stripesEnabled) {
      let e = ke(c, b),
        ...
        i = n
          ? [
              {
                ...
                render: () => {
                  let { cols: e, rows: t } = h,
                    r = x.get(O(), p.width, p.height, { linear: !0 }),
                    i = x.get("cellColor", e, t);
          ...
          : [],
        a = rt(c, b),
        u = E.renderMode === "sharp" ? null : xt(c, b),
        m = u ? Ct(c, b) : null,
        g = E.letters.enabled,
        _ = g ? Tt(c, b) : null,
        C = _
          ? [
              {
                ...
                render: () => {
                  ...
                  let n = x.get("cell", e, t),
                    i = x.get("glyphData", e, t),
                    a = Math.max(...wo(E).map((e) => e.startFrom));
        ...
        T = (e, t, n) => {
          let { cols: r, rows: i } = h,
            a = g && E.letters.mode === "text" ? kt(r, i) : g ? x.get("glyphData", r, i).texture : M.dummyTex;
          return {
            cols: r,
            rows: i,
            displayW: o,
      ...
      S = [
        ...
        ...ce,
        {
          ...
          render: () => {
            let { cols: t, rows: n } = h,
              r = x.get(w(), p.width, p.height, { linear: !0 }),
              i = x.get("cell", t, n);
        ...
        ...N,
        {
          ...
          render: () => {
            ...
            a.render(
              n.texture,
              D,
              nt(E, T(re, r ? r[0].texture : null, r ? r[1].texture : null)),
              f.width,
              f.height,
              u || F ? x.get("stripeOut", f.width, f.height, { linear: !0 }) : null,
              v,
              y,
            );
          },
          ...
          ? [
              {
                name: "logoFill",
                render: () => {
                  let e = x.get("stripeOut", f.width, f.height, { linear: !0 }),
                    t = x.get("solidOut", f.width, f.height, { linear: !0 });
          ...
          ? [
              {
                name: "stylize",
                render: () => {
                  let e = x.get("solidOut", f.width, f.height, { linear: !0 }),
                    t = x.get("stripeOut", f.width, f.height, { linear: !0 }),
                    n = F ? x.get("postSrc", f.width, f.height, { linear: !0 }) : null;
                  u.render(
                    n,
                    e.texture,
                    t.texture,
          ...
          ? [
              {
                name: "hookPost",
                render: () => {
                  let e = u ? "postSrc" : "stripeOut",
                    t = x.get(e, f.width, f.height, { linear: !0 });
      ...
      S = [
        ...
        ...ce,
        {
          ...
          render: () => {
            let t = e ? O() : w(),
              r = x.get(t, p.width, p.height, { linear: !0 }).texture;
  ...
  function Mt() {
    ...
    if (
      ((f = se(o, s, e, d)),
      t.applyOutputSize(f.width, f.height),
      (h = ho(o, s, E.grid.cellWidth, E.grid.cellHeight)),
      (m = ce(f, E.fieldScale)),
      (p = E.stripesEnabled && !i?.fieldPass ? F(m, h.cols, h.rows, 4) : m),
      x.get("field", p.width, p.height, { linear: !0 }),
      x.get("cell", h.cols, h.rows),
      E.renderMode !== "sharp" &&
        (x.get("stripeOut", f.width, f.height, { linear: !0 }), x.get("solidOut", f.width, f.height, { linear: !0 })),
      E.reveal.enabled && (x.get("revealedField", p.width, p.height, { linear: !0 }), E.reveal.type === "assembly"))
    ) {
      let e = Math.max(1, Math.round(p.width / 2)),
        t = Math.max(1, Math.round(p.height / 2));
      (x.get("assemblyBlurQuarter", e, t, { linear: !0 }),
        x.get("assemblyBlurHalf", e, t, { linear: !0 }),
        x.get("assemblyBlurFull", e, t, { linear: !0 }),
        x.get("assemblyBlurTemp", e, t, { linear: !0 }));
    }
  }
  function Nt(e) {
    ...
    ((c = n.gl),
      ...
      (Ue = r.now()),
      Ot(),
      M.ensureAtlas(E.letters.fontFamily),
      jt(),
      Mt());
  }
  function Pt(e) {
  ...
  (t.attachContextLossListeners(Pt, Ft),
    (Ae = Ro(c, b)),
    (Me = Bo(c, b)),
    Ot(),
    M.ensureAtlas(E.letters.fontFamily),
  ...
  let Lt = A({
    ...
    teardown: () => {
      ...
      ((H &&= (H.dispose(), null)),
        ...
        b.dispose(),
        T?.dispose(),
        (D &&= (c.deleteTexture(D), null)),
        (k &&= (c.deleteTexture(k), null)),
        M.dispose());
    },
  });
  return {
    ...
    setSource(e) {
      ...
      (T?.dispose(),
        (T = e ? po(c, e) : null),
        T && !t && xe.trigger(),
        (Ce = e ? bt(e) : E.colors.backgroundColor),
        St(e),
        Dt(),
        E.colors.mode === "colors" && jt());
    },
    updateSourceFrame(e) {
      if (!N) {
        if (!T) {
    ...
    setConfig(t) {
      ((E = e({
        ...
        M.ensureAtlas(E.letters.fontFamily),
        Mt(),
        E.colors.mode === "colors" && q() !== Pe && Dt(),
        E.flames.enabled && (!I || E.flames.direction !== L) && (Le = Ba(At(Fe))),
        (L = E.flames.direction),
        (E.stripesEnabled !== P ||
          oe() !== le ||
          E.flames.enabled !== I ||
          ($e(E) === "field") !== ue ||
          E.renderMode !== me ||
          E.cursorTrail.enabled !== ge ||
          E.cursorTrail.type !== qe ||
          Qe() !== et ||
          it() !== K ||
          E.clickWave.enabled !== R ||
          E.clickWave.type !== _e ||
          lt() !== ut ||
          E.letters.enabled !== ve ||
          E.colors.mode !== be ||
          E.background.stars.enabled !== B ||
          ot() !== st) &&
          (E.background.stars.enabled && !B && (Be = un(At(ze))),
          E.cursorTrail.enabled && !ge && ((W = Vi()), (Ue = r.now())),
          E.clickWave.enabled && !R && ((He = Xi()), (dt = null), (ft = ""), (Ue = r.now())),
          jt(),
          (P = E.stripesEnabled),
          (le = oe()),
          (I = E.flames.enabled),
    ...
    click(e, t) {
      if (ct()) {
        Ni(pt(), E.clickWave.detonation, e, t ?? 0, (r.now() - a) * 0.001);
        return;
      }
      Zi(
        He,
    ...
    readOutputPixels() {
      ...
      return (
        c.bindFramebuffer(c.FRAMEBUFFER, null), c.readPixels(0, 0, f.width, f.height, c.RGBA, c.UNSIGNED_BYTE, e), e
      );
    },
    readCellGrid() {
      let { cols: e, rows: t } = h,
      ...
      if (E.colors.mode === "colors") {
        ...
        ((a = new Uint8Array(e * t * 4)),
          c.bindFramebuffer(c.FRAMEBUFFER, n.fbo),
          c.readPixels(0, 0, e, t, c.RGBA, c.UNSIGNED_BYTE, a));
      }
      return (
        c.bindFramebuffer(c.FRAMEBUFFER, null),
        {
...
function ls(e, t) {
  ...
  let n = [...t].sort((e, t) => e.startFrom - t.startFrom),
    r = -1;
...
var us = ["default", "wave", "constellation", "comet"],
...
function gs(e, t) {
  ...
  (n &&
    ...
    (e.background.gradient.enabled
      ? (r.gradient = {
          ...e.background.gradient,
          stops: [...e.background.gradient.stops],
        })
      : t && (r.gradient = { enabled: !1 }),
    e.background.grid.enabled ? (r.grid = { ...e.background.grid }) : t && (r.grid = { enabled: !1 })),
    e.background.stars.enabled ? (r.stars = { ...e.background.stars }) : t && (r.stars = { enabled: !1 }),
    e.background.meteors.enabled ? (r.meteors = { ...e.background.meteors }) : t && (r.meteors = { enabled: !1 }));
  let i = {
  ...
  if (n) {
    ...
    let a = {};
    for (let n of ["gaps", "width", "stripe", "motion"]) {
      let r = e.sparkle[n];
      r.enabled ? (a[n] = { ...r }) : t && (a[n] = { enabled: !1 });
    }
    (Object.keys(a).length > 0 && (i.sparkle = a),
      e.stripeDots.enabled ? (i.stripeDots = { ...e.stripeDots }) : t && (i.stripeDots = { enabled: !1 }),
      e.stripeBorder.enabled ? (i.stripeBorder = { ...e.stripeBorder }) : t && (i.stripeBorder = { enabled: !1 }),
      e.gridLines.enabled ? (i.gridLines = { ...e.gridLines }) : t && (i.gridLines = { enabled: !1 }),
      e.letters.enabled ? (i.letters = { ...e.letters }) : t && (i.letters = { enabled: !1 }),
      e.renderMode === "sharp"
        ? t && (i.renderMode = "sharp")
        : ((i.renderMode = e.renderMode),
          (i.renderIntensity = e.renderIntensity),
          (i.renderParams = [...e.renderParams]),
          (i.renderColorA = e.renderColorA),
          (i.renderColorB = e.renderColorB)));
  }
  let a = hs(e.reveal, t);
  if ((a && (i.reveal = a), e.flames.enabled)) {
    let { vortexSingular: t, ...n } = e.flames;
    i.flames =
      e.flames.direction === "vortexSingular"
        ? {
            ...n,
            vortexSingular: { ...t },
          }
  ...
  if (
    (e.edgeMask.enabled
      ...
      : t && (i.edgeMask = { enabled: !1 }),
    e.cursorTrail.enabled)
  ) {
    let { constellation: t, comet: n, ...r } = e.cursorTrail;
    e.cursorTrail.type === "default"
      ? (i.cursorTrail = r)
      : e.cursorTrail.type === "constellation"
        ? (i.cursorTrail = {
            enabled: !0,
            type: "constellation",
            constellation: { ...t },
          })
        : e.cursorTrail.type === "comet"
          ? (i.cursorTrail = {
              enabled: !0,
              type: "comet",
              comet: { ...n },
...
function Cs(e) {
  ...
  return {
    ...
    wave: {
      ...
      softness: typeof t.softness == "number" ? t.softness : 0.22,
      waviness: typeof t.waviness == "number" ? t.waviness : 0.11,
    },
    assembly: {
      sliceSizePx: 40,
...
function ws(e) {
  ...
  let n = {};
  return (
    bs(t.textureAdjustments) && (n.adjustments = t.textureAdjustments),
    bs(t.sourceTransform) && (n.transform = t.sourceTransform),
    bs(t.grid) && (n.grid = t.grid),
    typeof t.backgroundColor == "number" &&
      (n.background = a({
        color: t.backgroundColor,
        transparent: !1,
      })),
    Array.isArray(t.stripes) && (n.stripes = t.stripes.map(Ss)),
    typeof t.stripesEnabled == "boolean" && (n.stripesEnabled = t.stripesEnabled),
    bs(t.reveal) && (n.reveal = Cs(t.reveal)),
    n
  );
}
//#endregion
...
function Ms(e, t, n, r = Ts, i = Es, m = 1) {
  ...
  let a = Math.max(0, Math.min(0.1, t - e.lastTimeSec)),
    o = e.mode,
    s = e.formation,
    c = 0,
    l = e.rejoinProgress,
    u = e.rejoinStartFieldTimeSec,
    d = e.rejoinStartFormation,
    f = e.rejoinStartFormationVelocity;
  if ((o === "field" && n && (o = "forming"), o === "forming"))
    !n && s <= Ds
      ? ((o = "field"), (s = 0), (c = 0), (l = 0), (u = t), (d = 0), (f = 0))
      : !n && s > 0
        ? ((o = "rejoining"), (l = 0), (u = t), (d = s), (f = e.formationVelocity))
        : ((s = Math.min(1, s + a / Math.max(r, 0.001))),
          s > 0.999999 && (s = 1),
          (c = a > 0 ? (s - e.formation) / a : 0),
          s === 1 && (o = "logo"));
  else if (o === "logo" && !n) ((o = "rejoining"), (l = 0), (u = t), (d = 1), (f = 0));
  else if (o === "rejoining") {
    let e = As(Math.max(i, 0.001));
    if (n && m === 0) ((o = "forming"), (s = 0), (c = 0), (l = 0));
    else if (n && m === 1) {
      u += 5 * a;
      let p = t - u;
      p <= 0
        ? ((o = "forming"), (s = Math.max(0, Math.min(1, d))), (c = 0), (l = 0), (u = t))
        : (l = Math.min(1, p / e));
    } else
      ((l = Math.min(1, Math.max(0, t - u) / e)),
        l > 0.999999 && (l = 1),
        l === 1 && ((s = 0), (c = 0), (l = 0), (o = n ? "forming" : "field")));
  }
  return {
    fieldTimeSec: t,
    formation: s,
...
var Z = [
  ...
  Ns = Z.length,
  Ps = Z.filter((e, t) => t <= 20 || (t >= 36 && t <= 46) || t >= 79),
  Fs = 64,
  Is = 64,
  Ls = Ns + 160,
  Rs = Ns + 160,
...
function Hs(e) {
  let t = e && typeof e == "object" ? e : {},
    n = t.version !== 2 && t.formationDuration === 1.8 ? Q.formationDuration : t.formationDuration;
  return {
    version: 2,
    fieldSpeed: $(t.fieldSpeed, Q.fieldSpeed, 0, 4),
    fieldDepth: $(t.fieldDepth, Q.fieldDepth, 2, 12),
    fieldSpread: $(t.fieldSpread, Q.fieldSpread, 0.5, 5),
    ...
    fieldParticleSize: $(t.fieldParticleSize, Q.fieldParticleSize, 0.25, 3),
    logoScale: $(t.logoScale, Q.logoScale, 0.35, 1.5),
    logoParticleSize: $(t.logoParticleSize, Q.logoParticleSize, 0.25, 3),
    ...
    formationDuration: $(n, Q.formationDuration, 0.2, 6),
    rejoinDuration: $(t.rejoinDuration, Q.rejoinDuration, 0.2, 6),
    formationStagger: $(t.formationStagger, Q.formationStagger, 0, 0.9),
    centerPreference: $(t.centerPreference, Q.centerPreference, 0, 1),
    sparkFrequency: $(t.sparkFrequency, Q.sparkFrequency, 0.1, 4),
    sparkSize: $(t.sparkSize, Q.sparkSize, 0.2, 3),
    ...
    fireScale: $(t.fireScale, Q.fireScale, 0.25, 3),
    ...
    flameHeight: $(t.flameHeight, Q.flameHeight, 0.2, 3),
    ...
    eruptionScale: $(t.eruptionScale, Q.eruptionScale, 0.2, 3),
    ...
    eruptionCycleSpeed: $(t.eruptionCycleSpeed, Q.eruptionCycleSpeed, 0.1, 4),
  };
}
//#endregion
...
function Ys(e) {
  let t = Js(e, e.VERTEX_SHADER, Gs),
    n = Js(e, e.FRAGMENT_SHADER, Ks),
    r = e.createProgram();
...
function Xs(e, t) {
  ...
  let o = r.getUniformLocation(i, "uResolution"),
    ...
    S = !1,
    C = (e, t) => {
      let r = Math.max(1, Math.round(e * qs)),
        i = Math.max(1, Math.round(t * qs));
  ...
  return (
    C(e, t),
    {
      ...
      render(e, t, C) {
        ...
        let w = Hs(C),
          T = v.mode;
        ((v = Ms(v, e, t.hovered, w.formationDuration, w.rejoinDuration, w.formationInterrupt)),
          v.mode === "forming" &&
            T !== "forming" &&
            (w.formationMode > 0.5 || T === "field" || v.formation <= 0.001) &&
            ((y = Math.max(0, Math.min(1, t.x / Math.max(1, n.width)))),
            (b = Math.max(0, Math.min(1, t.y / Math.max(1, n.height)))),
            (x = v.fieldTimeSec)),
          ...
          r.useProgram(i),
          r.bindVertexArray(a),
          r.uniform2f(o, n.width, n.height),
          r.uniform1f(s, v.fieldTimeSec),
          r.uniform1f(c, v.formation),
          r.uniform1f(l, +(v.mode === "rejoining")),
          r.uniform1f(u, v.rejoinProgress),
          r.uniform1f(d, Math.max(0, v.fieldTimeSec - v.rejoinStartFieldTimeSec)),
          r.uniform1f(f, v.rejoinStartFieldTimeSec),
          r.uniform1f(p, v.rejoinStartFormation),
          r.uniform1f(m, w.rejoinDuration),
          r.uniform2f(h, y * n.width, b * n.height),
          r.uniform1f(g, x));
        let E = {
...
//#endregion
export {
  ds as CLICK_WAVE_TYPES,
  Is as COMET_LOGO_BACKGROUND_POINT_COUNT,
  Vs as COMET_LOGO_CONFIG_VERSION,
  Q as COMET_LOGO_DEFAULTS,
  Ts as COMET_LOGO_FORMATION_DURATION_SEC,
  Fs as COMET_LOGO_IDLE_BACKGROUND_POINT_COUNT,
  Ls as COMET_LOGO_IDLE_RENDER_POINT_COUNT,
  Z as COMET_LOGO_POINTS,
  Ns as COMET_LOGO_POINT_COUNT,
  Es as COMET_LOGO_REJOIN_DURATION_SEC,
  Rs as COMET_LOGO_RENDER_POINT_COUNT,
  qs as COMET_LOGO_RENDER_SCALE,
  Bs as COMET_LOGO_TRAIL_SEGMENT_COUNT,
  us as CURSOR_TRAIL_TYPES,
  p as DEFAULT_BACKGROUND_METEORS,
  o as DEFAULT_CLICK_WAVE,
  _ as DEFAULT_COMET_TRAIL,
  c as DEFAULT_DETONATION_CLICK,
  m as DEFAULT_ENGINE_CONFIG,
  S as DEFAULT_FRAMES,
  l as DEFAULT_GRID_LINES,
  v as DEFAULT_STRIPE_BORDER,
  h as DEFAULT_STRIPE_DOTS,
  Zs as ENGINE_PACKAGE,
  B as FULLSCREEN_VERT,
  Ms as advanceCometLogoAnimation,
  Co as applyImageColorDensity,
  ls as bandIndexForValue,
  z as bindRenderTarget,
  Kr as cometCaps,
  As as cometLogoRejoinWindowSec,
  P as compileProgram,
  js as createCometLogoAnimationState,
  Xs as createCometLogoTextureRenderer,
  Rt as createDataTexture,
  ae as createFullscreenQuad,
  k as createManualClock,
  la as createPingPong,
  vs as createProductionConfig,
  O as createRealClock,
  R as createRenderTarget,
  kt as createSeededRng,
  os as createStripesEngine,
  ss as createStripesEngineShared,
  Di as detonationCaps,
  x as diffEngineConfig,
  ve as disposeRenderTarget,
  wo as effectiveStripes,
  mi as meteorsCaps,
  ws as migrateLegacyConfig,
  C as normalizeBackgroundMeteors,
  Hs as normalizeCometLogoSettings,
  s as normalizeCometTrail,
  r as normalizeDetonationClick,
  e as normalizeEngineConfig,
  w as normalizeFrames,
  i as normalizeGridLines,
  n as normalizeStripeBorder,
  t as normalizeStripeDots,
  ps as parseEngineConfig,
  _e as resizeRenderTarget,
  g as resolveThemedConfig,
  y as sanitizeThemedConfig,
  fs as serializeEngineConfig,
  ys as serializeProductionConfig,
  vo as stripeDotBandEligibility,
  D as subscribeStripesStats,
  zt as updateDataTexture,
};
