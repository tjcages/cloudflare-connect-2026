...
var t = (e, t) => (typeof e == "number" && Number.isFinite(e) ? e : t),
  n = {
    fit: "width",
    zoom: 1,
    panX: 0,
...
function r(n = {}) {
  return {
    fit:
      n.fit === "contain" || n.fit === "cover" || n.fit === "stretch" || n.fit === "width" || n.fit === "height"
        ? n.fit
        : "width",
    zoom: e(t(n.zoom, 1), 0.1, 8),
    panX: e(t(n.panX, 0), -1, 1),
    panY: e(t(n.panY, 0), -1, 1),
  };
}
var i = ["topToBottom", "leftToRight", "rightToLeft", "bottomToTop"];
function a(e) {
  return i.indexOf(e);
}
var o = {
...
function s(n = {}) {
  ...
  return {
    ...
    stops: [0, 1, 2, 3].map((n) => Math.round(e(t(r[n], o.stops[n]), 0, 16777215))),
...
function l(n = {}) {
  let r = c,
    i = e(t(n.lifetimeMinMs, r.lifetimeMinMs), 60, 2e4),
    a = Math.max(i, e(t(n.lifetimeMaxMs, r.lifetimeMaxMs), 60, 2e4));
  return {
    enabled: n.enabled === void 0 ? r.enabled : !!n.enabled,
    ratePerSec: e(t(n.ratePerSec, r.ratePerSec), 0.02, 120),
    ...
    speedScale: e(t(n.speedScale, r.speedScale), 0.05, 6),
    speedVariation: e(t(n.speedVariation, r.speedVariation), 0, 1),
    tailLengthScale: e(t(n.tailLengthScale, r.tailLengthScale), 0.05, 6),
    tailLengthVariation: e(t(n.tailLengthVariation, r.tailLengthVariation), 0, 1),
    thicknessScale: e(t(n.thicknessScale, r.thicknessScale), 0.05, 6),
    ...
    pushFalloffScale: e(t(n.pushFalloffScale, r.pushFalloffScale), 0.05, 8),
...
function d(n = {}) {
  let r = n.grid ?? {},
    i = n.stars ?? {},
    a = n.gradient ?? {},
    o = e(Math.round(t(r.cellWidth, u.grid.cellWidth)), 4, 512),
    c = e(Math.round(t(r.cellHeight, u.grid.cellHeight)), 4, 512);
  return {
    ...
    stars: {
      ...
      sizePx: e(t(i.sizePx, u.stars.sizePx), 0.25, 64),
...
function ee(n = {}) {
  let r = e(Math.round(t(n.cellWidth, 7)), 1, 64),
    i = e(Math.round(t(n.cellHeight, 7)), 1, 64),
    a = n.orientation === "horizontal" ? "horizontal" : "vertical";
  return {
    cellWidth: r,
    cellHeight: i,
...
function ne(n = {}) {
  ...
  return {
    ...
    blackPoint: r,
    whitePoint: e(t(n.whitePoint, 1), r + 0.01, 1),
    gamma: Math.max(0.05, t(n.gamma, 1)),
    invert: !!n.invert,
...
var ie = [
  ...
  ae = ["wave", "assembly", "turbulence", "glitch", "vortex", "blackhole", "whirlpool", "water", "custom"],
  h = {
    enabled: !1,
    type: "assembly",
    wave: {
...
function g(n) {
  let r = n.scatter ?? {},
    i = h.assembly,
    a = e(Math.round(t(r.speedMinMs ?? n.speedMinMs, i.speedMinMs)), 100, 3e4),
    o = Math.max(a, e(Math.round(t(r.speedMaxMs ?? n.speedMaxMs, i.speedMaxMs)), 100, 3e4));
  return {
    ...
    blurStart: e(t(r.blurStart ?? n.blurStart, i.blurStart ?? 0.45), 0, 0.95),
  };
}
function _(n = {}, r) {
...
function oe(n = {}, r) {
  return {
    ...
    horizon: e(t(n.horizon, r.horizon), 0.02, 0.3),
  };
}
function y(n = {}, r) {
  return {
    ...
    tightness: e(t(n.tightness, r.tightness), 0.05, 0.5),
...
function se(n = {}) {
  let r = n.wave ?? {},
    i = n.assembly ?? {},
    a = ie.includes(r.position) ? r.position : h.wave.position,
    o = n.type,
    s = i.style;
  (o === "assembly" &&
    (s === "turbulence" || s === "glitch" || s === "hadouken" || s === "vortex") &&
    (o = s === "hadouken" ? "vortex" : s),
    o === "hadouken" && (o = "vortex"));
...
var ce = ["leftToRight", "rightToLeft", "topToBottom", "bottomToTop"],
  x = {
    gaps: {
      enabled: !1,
      coverage: 0.22,
...
function le(n = {}) {
  ...
  return {
    gaps: {
      ...
      speed: e(t(r.speed, x.gaps.speed), 0.05, 100),
    },
    width: {
      ...
      swingPeriodMin: e(t(i.swingPeriodMin, x.width.swingPeriodMin), 0.02, 5),
      swingPeriodMax: e(t(i.swingPeriodMax, x.width.swingPeriodMax), 0.02, 5),
    },
    stripe: {
      ...
      speed: e(t(a.speed, x.stripe.speed), 0.05, 100),
    ...
    motion: {
      ...
      speed: Math.max(0.05, t(o.speed, x.motion.speed)),
...
var A = {
  ...
  ue = ["up", "down", "left", "right", "upDown", "leftRight", "vortexSingular"];
function de(e) {
  return ue.includes(e) ? e : "up";
}
function fe(n = {}) {
  let r = e(Math.round(t(n.lifeMinMs, A.lifeMinMs)), 500, 6e4),
    i = e(Math.round(t(n.visibleMinMs, A.visibleMinMs)), 500, 6e4),
    a = e(Math.round(t(n.hiddenMinMs, A.hiddenMinMs)), 0, 3e4);
  return {
    segCount: e(Math.round(t(n.segCount, A.segCount)), 2, 80),
    segSpacingPx: e(t(n.segSpacingPx, A.segSpacingPx), 2, 60),
    turnRate: e(t(n.turnRate, A.turnRate), 0.05, 6),
    ...
    edgeMarginRatio: e(t(n.edgeMarginRatio, A.edgeMarginRatio), 0, 0.4),
  };
}
function pe(n = {}) {
  let r = e(t(n.minWidthRatio, j.minWidthRatio), 0.001, 0.5),
    i = e(t(n.maxWidthRatio, j.maxWidthRatio), r, 0.5),
    a = e(t(n.minHeightRatio, j.minHeightRatio), 0.001, 0.5),
    o = e(t(n.maxHeightRatio, j.maxHeightRatio), a, 0.5),
    s = e(t(n.opacityMin, j.opacityMin), 0, 1),
    c = e(t(n.opacityMax, j.opacityMax), s, 1);
  return {
...
function N(n = {}) {
  let r = e(t(n.start, M.start), 0, 0.5),
    i = e(t(n.end, M.end), r + 0.001, 0.5);
  return {
    enabled: n.enabled === void 0 ? M.enabled : !!n.enabled,
    start: r,
    end: i,
    power: e(t(n.power, M.power), 0.1, 4),
    sides: me(n.sides),
  };
}
var P = {
...
function F(n = {}) {
  let r = P;
  return {
    radiusScale: e(t(n.radiusScale, r.radiusScale), 0.02, 2),
    starDensity: e(t(n.starDensity, r.starDensity), 0.05, 4),
    starSizePx: e(t(n.starSizePx, r.starSizePx), 0.2, 20),
    ...
    linkThicknessPx: e(t(n.linkThicknessPx, r.linkThicknessPx), 0.2, 20),
    ...
    linkMaxDistScale: e(t(n.linkMaxDistScale, r.linkMaxDistScale), 0.02, 1),
    ...
    pulseCoreLenPx: e(t(n.pulseCoreLenPx, r.pulseCoreLenPx), 0.5, 60),
    pulseTailLenPx: e(t(n.pulseTailLenPx, r.pulseTailLenPx), 0.5, 240),
...
function L(n = {}) {
  let r = I,
    i = e(t(n.emberSpeedMinPxPerSec, r.emberSpeedMinPxPerSec), 0, 2e3),
    a = Math.max(i, e(t(n.emberSpeedMaxPxPerSec, r.emberSpeedMaxPxPerSec), 0, 2e3)),
    o = e(t(n.emberLifetimeMinMs, r.emberLifetimeMinMs), 60, 2e4),
    s = Math.max(o, e(t(n.emberLifetimeMaxMs, r.emberLifetimeMaxMs), 60, 2e4));
  return {
    ...
    presenceRiseRate: e(t(n.presenceRiseRate, r.presenceRiseRate), 0.5, 60),
    presenceFallRate: e(t(n.presenceFallRate, r.presenceFallRate), 0.2, 60),
    ...
    emberSizePx: e(t(n.emberSizePx, r.emberSizePx), 0.2, 40),
    ...
    emberFadeInFraction: e(t(n.emberFadeInFraction, r.emberFadeInFraction), 0, 0.9),
...
function B(n = {}) {
  let r = e(t(n.spreadMinPx, R.spreadMinPx), 0, 80),
    i = Math.max(r, e(t(n.spreadMaxPx, R.spreadMaxPx), 0, 120));
  return {
    enabled: n.enabled === void 0 ? R.enabled : !!n.enabled,
    type: n.type === "wave" || n.type === "constellation" || n.type === "comet" ? n.type : "default",
    particleRadius: e(t(n.particleRadius, R.particleRadius), 0.5, 80),
    ...
    emitterVelocitySmoothing: e(t(n.emitterVelocitySmoothing, R.emitterVelocitySmoothing), 0, 0.98),
    ...
    particleSpacingPx: e(t(n.particleSpacingPx, R.particleSpacingPx), 0.5, 80),
    maxEmitPerTick: z(t(n.maxEmitPerTick, R.maxEmitPerTick), 1, 200),
    spreadMinPx: r,
    spreadMaxPx: i,
    spinStrength: e(t(n.spinStrength, R.spinStrength), 0, 0.2),
...
function H(n = {}) {
  ...
  return {
    ...
    debrisDrag: e(t(n.debrisDrag, r.debrisDrag), 0.05, 12),
    ...
    debrisSizePx: e(t(n.debrisSizePx, r.debrisSizePx), 0.2, 40),
...
function W(n = {}) {
  return {
    ...
    startStrokeWidthPx: e(t(n.startStrokeWidthPx, U.startStrokeWidthPx), 0.5, 80),
    endStrokeWidthPx: e(t(n.endStrokeWidthPx, U.endStrokeWidthPx), 0.25, 40),
...
function ge(n = {}) {
  return {
    ...
    areaWidth: e(t(n.areaWidth, G.areaWidth), 0.01, 1),
    areaHeight: e(t(n.areaHeight, G.areaHeight), 0.01, 1),
    ...
    sizeScale: e(t(n.sizeScale, G.sizeScale), 0.1, 1),
    shuffleSpeed: e(t(n.shuffleSpeed, G.shuffleSpeed), 0.05, 10),
  };
}
var K = ["normal", "multiply", "screen", "overlay", "darken", "lighten", "difference", "exclusion"],
  _e = Object.fromEntries(K.map((e, t) => [e, t])),
  q = {
    mode: "luminance",
...
function ve(n = {}) {
  ...
  return {
    ...
    imageColorRemoveThin: e(t(n.imageColorRemoveThin, q.imageColorRemoveThin), 0, 0.95),
...
function xe(n) {
  let r = Array.isArray(n) ? n : [],
    i = [];
  for (let n = 0; n < 4; n++) i.push(e(t(r[n], 0.5), 0, 1));
  return i;
}
var Se = {
  transform: n,
...
function J(n = {}) {
  return {
    ...
    fieldScale: e(t(n.fieldScale, 1), 0.25, 2),
