...
export const SPEAKER_SHADER_CONFIG = {
  ...
  stripes: [
    { color: 2494726, startFrom: 0, width: 0.5, opacity: 1 },
    { color: 3347975, startFrom: 0.0195, width: 0.5, opacity: 1 },
    { color: 4464653, startFrom: 0.047, width: 1, opacity: 1 },
    { color: 5973518, startFrom: 0.086, width: 1.5, opacity: 1 },
    { color: 9054977, startFrom: 0.1408, width: 1.5, opacity: 1 },
    { color: 11745286, startFrom: 0.2167, width: 2, opacity: 1 },
    { color: 16015393, startFrom: 0.3191, width: 2.5, opacity: 1 },
    { color: 16280064, startFrom: 0.4512, width: 3, opacity: 1 },
    { color: 16746553, startFrom: 0.6129, width: 3.5, opacity: 1 },
    { color: 16752731, startFrom: 0.8, width: 4, opacity: 1 },
  ],
  stripesEnabled: true,
  fieldScale: 1,
  maxFps: 0,
