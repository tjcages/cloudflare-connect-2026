...
export default function BadgeShareDock({
  ...
  return createPortal(
    <div className="pointer-events-none fixed inset-x-0 bottom-0 z-60 flex justify-center p-16 max-sm:p-12">
      <div className="pointer-events-auto relative w-full max-w-520 overflow-hidden bg-background-base shadow-elevation-default">
        <Button
        ...
        <p className="px-16 py-12 text-label-x-small text-text-muted">
