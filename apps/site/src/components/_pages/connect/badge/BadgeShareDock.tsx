...
import BadgeLightbox from "./BadgeLightbox";
...
export default function BadgeShareDock({
  ...
  const [lightbox, setLightbox] = useState<{ rect?: DOMRect } | null>(null);

  function openLightbox() {
    setLightbox({ rect: imgRef.current?.getBoundingClientRect() });
  }
