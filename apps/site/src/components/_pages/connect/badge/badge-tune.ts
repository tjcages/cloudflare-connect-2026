...
export const BADGE_TUNE_FIELDS: PanelField<BadgeTune>[] = [
  ...
  slider("cardOverlap", "Hook overlap", 0, 0.02, 0.001),
  ...
  slider(
    ...
    1.8,
    0.01,
    "Below 1 shows more of the Twizzler and rain."
  ),
  ...
  slider("logoPadY", "Pad Y", 0.01, 0.12, 0.005),
  ...
  slider(
    ...
    1,
    0.01,
    "0 keeps the stripe-filled mark. Raise to wash white on top."
  ),
...
export const BADGE_TUNE_PANEL_ID = "connect-badge-tune";
