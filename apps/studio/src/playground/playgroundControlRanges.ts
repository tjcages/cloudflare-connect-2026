...
export const PLAYGROUND_CONTROL_RANGES = {
  ...
  flamesOpacity: { min: 0, max: 1, step: 0.01 },
  edgeMaskInset: { min: 0, max: 50, step: 0.1 },
  edgeMaskPower: { min: 0.1, max: 4, step: 0.05 },
  revealDurationMs: { min: 100, max: 6000, step: 50 },
  revealStaggerMs: { min: 0, max: 12000, step: 50 },
  revealSpeedMs: { min: 100, max: 8000, step: 50 },
...
export const PLAYGROUND_CONTROL_INPUT_BOUNDS = {
  ...
  flamesOpacity: { min: 0, max: 1 },
  edgeMaskInset: { min: 0, max: 50 },
  edgeMaskPower: { min: 0.1, max: 4 },
  revealDurationMs: { min: 100, max: 30_000 },
  revealStaggerMs: { min: 0, max: 30_000 },
